...
static const qwen_loom_source_mapping_t qwen_loom_source_mappings[] = {
    ...
    {
        .module_path = IREE_SVL(QWEN_LOOM_SOURCE_ROUTE_TRACE),
        .embedded_name = IREE_SVL("qwen3_moe_route_trace.loom"),
    },
    {
    ...
    {
        .module_path = IREE_SVL(QWEN_LOOM_SOURCE_ROUTED_GATE_UP_Q8),
        .embedded_name = IREE_SVL("qwen3_moe_routed_gate_up_q8.loom"),
    },
    {
