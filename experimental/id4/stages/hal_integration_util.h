...
typedef struct StageDiagnostics {
  ...
  // Number of prepare-time encoded staging window allocations observed.
  iree_host_size_t parameter_prepare_encode_window_count;
  // Total prepare-time encoded staging window bytes observed.
  iree_device_size_t parameter_prepare_encode_window_staging_total_byte_length;
  // Largest prepare-time encoded staging window byte length observed.
  iree_device_size_t parameter_prepare_encode_window_staging_max_byte_length;
  // Total provider source bytes planned through prepare-time encode windows.
  iree_device_size_t parameter_prepare_encode_window_source_byte_length;
  // Total final slab bytes planned through prepare-time encode windows.
  ...
  // Number of encoder dispatches planned through prepare-time encode windows.
  iree_host_size_t parameter_prepare_encode_window_encoder_dispatch_count;
