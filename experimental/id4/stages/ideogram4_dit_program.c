...
iree_status_t id4_ideogram4_dit_weight_execution_format_parse(
  ...
  if (iree_string_view_equal(value, IREE_SV("fp8_compact_rhs"))) {
    *out_format = ID4_IDEOGRAM4_DIT_WEIGHT_EXECUTION_FORMAT_FP8_COMPACT_RHS;
    return iree_ok_status();
  }
  if (iree_string_view_equal(
          value, IREE_SV("fp8_compact_rhs_feed_forward_bf16_resident"))) {
    *out_format =
  ...
  return iree_make_status(
      ...
      "DiT weight execution format must be bf16_resident, fp8_compact_rhs, "
      "fp8_compact_rhs_feed_forward_bf16_resident, or streaming_compact_rhs");
}
...
static iree_status_t id4_ideogram4_dit_program_dispatch_prelude_image_scalar(
...
static iree_status_t
id4_ideogram4_dit_program_dispatch_prelude_image_pack_f32_bf16(
    id4_pipeline_program_builder_t* builder, uint32_t image_token_count,
    uint32_t image_width, uint32_t image_height, uint32_t input_channel_count,
    id4_pipeline_program_tensor_t input, id4_pipeline_program_tensor_t output) {
  const id4_ideogram4_dit_program_config_value_t config_values[] = {
      {IREE_SV("id4.ideogram4.prelude_image_pack.token_count"),
       image_token_count},
      {IREE_SV("id4.ideogram4.prelude_image_pack.image_width"), image_width},
      {IREE_SV("id4.ideogram4.prelude_image_pack.image_height"), image_height},
      {IREE_SV("id4.ideogram4.prelude_image_pack.input_channel_count"),
       input_channel_count},
  };
  char value_buffers[ID4_IDEOGRAM4_DIT_MAX_KERNEL_CONFIG_BINDING_COUNT]
                    [ID4_IDEOGRAM4_DIT_CONFIG_VALUE_BUFFER_CAPACITY];
  ...
  return id4_ideogram4_dit_program_dispatch_loom(
      builder, IREE_SV("ideogram4.prelude.image_input_pack"),
      IREE_SV("ideogram4/prelude_image_pack_f32_bf16"),
      IREE_SV("id4_ideogram4_prelude_image_pack_f32_bf16"),
      IREE_ARRAYSIZE(config_values), config_bindings, IREE_ARRAYSIZE(bindings),
      bindings);
}

static iree_status_t
id4_ideogram4_dit_program_dispatch_prelude_indicator_bf16_f32(
    id4_pipeline_program_builder_t* builder, uint32_t image_token_count,
    uint32_t total_token_count, uint32_t output_token_offset,
    uint32_t hidden_size, id4_pipeline_program_tensor_t projected,
    id4_pipeline_program_tensor_t image_indicator,
    id4_pipeline_program_tensor_t image_indicator_embedding,
    id4_pipeline_program_tensor_t output) {
  const id4_ideogram4_dit_program_config_value_t config_values[] = {
      {IREE_SV("id4.ideogram4.prelude_indicator.token_count"),
       image_token_count},
      {IREE_SV("id4.ideogram4.prelude_indicator.total_token_count"),
       total_token_count},
      {IREE_SV("id4.ideogram4.prelude_indicator.output_token_offset"),
       output_token_offset},
      {IREE_SV("id4.ideogram4.prelude_indicator.hidden_size"), hidden_size},
  };
  char value_buffers[ID4_IDEOGRAM4_DIT_MAX_KERNEL_CONFIG_BINDING_COUNT]
                    [ID4_IDEOGRAM4_DIT_CONFIG_VALUE_BUFFER_CAPACITY];
  id4_pipeline_kernel_config_binding_t
  ...
  return id4_ideogram4_dit_program_dispatch_loom(
      builder, IREE_SV("ideogram4.prelude.image_indicator"),
      IREE_SV("ideogram4/prelude_indicator_bf16_f32"),
      IREE_SV("id4_ideogram4_prelude_indicator_bf16_f32"),
      IREE_ARRAYSIZE(config_values), config_bindings, IREE_ARRAYSIZE(bindings),
      bindings);
}

static iree_status_t id4_ideogram4_dit_program_dispatch_prelude_indicator_bf16(
    id4_pipeline_program_builder_t* builder, iree_string_view_t name,
    uint32_t valid_token_count, uint32_t token_capacity,
    uint32_t total_token_count, uint32_t output_token_offset,
    uint32_t hidden_size, id4_pipeline_program_tensor_t projected,
    id4_pipeline_program_tensor_t image_indicator,
    id4_pipeline_program_tensor_t image_indicator_embedding,
  ...
  if (valid_token_count == 0 || valid_token_count > token_capacity) {
    return iree_make_status(
        IREE_STATUS_INVALID_ARGUMENT,
        "Ideogram4 prelude indicator valid token count %" PRIu32
        " exceeds capacity %" PRIu32,
        valid_token_count, token_capacity);
  }
  if (output_token_offset > total_token_count ||
      valid_token_count > total_token_count - output_token_offset) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Ideogram4 prelude indicator output range [%" PRIu32
                            ", %" PRIu32 ") exceeds total token count %" PRIu32,
                            output_token_offset,
                            output_token_offset + valid_token_count,
                            total_token_count);
  }
  iree_device_size_t output_row_byte_length = 0;
  iree_device_size_t output_offset = 0;
  iree_device_size_t output_length = 0;
  if (!iree_device_size_checked_mul((iree_device_size_t)hidden_size,
                                    id4_pipeline_program_dtype_byte_length(
                                        ID4_PIPELINE_PROGRAM_DTYPE_BF16),
                                    &output_row_byte_length) ||
      !iree_device_size_checked_mul((iree_device_size_t)output_token_offset,
                                    output_row_byte_length, &output_offset) ||
      !iree_device_size_checked_mul((iree_device_size_t)valid_token_count,
                                    output_row_byte_length, &output_length)) {
    return iree_make_status(
        IREE_STATUS_OUT_OF_RANGE,
        "Ideogram4 prelude indicator output byte range overflow");
  }
  const id4_ideogram4_dit_program_config_value_t config_values[] = {
      {IREE_SV("id4.ideogram4.prelude_indicator_bf16.valid_token_count"),
       valid_token_count},
      {IREE_SV("id4.ideogram4.prelude_indicator_bf16.token_capacity"),
       token_capacity},
      {IREE_SV("id4.ideogram4.prelude_indicator_bf16.total_token_count"),
       total_token_count},
      {IREE_SV("id4.ideogram4.prelude_indicator_bf16.output_token_offset"),
       output_token_offset},
      {IREE_SV("id4.ideogram4.prelude_indicator_bf16.hidden_size"),
       hidden_size},
  };
  char value_buffers[ID4_IDEOGRAM4_DIT_MAX_KERNEL_CONFIG_BINDING_COUNT]
                    [ID4_IDEOGRAM4_DIT_CONFIG_VALUE_BUFFER_CAPACITY];
  ...
  return id4_ideogram4_dit_program_dispatch_loom(
      builder, name, IREE_SV("ideogram4/prelude_indicator_bf16"),
      IREE_SV("id4_ideogram4_prelude_indicator_bf16"),
      IREE_ARRAYSIZE(config_values), config_bindings, IREE_ARRAYSIZE(bindings),
      bindings);
}
...
static iree_status_t id4_ideogram4_dit_program_dispatch_condition_rmsnorm_pack(
    id4_pipeline_program_builder_t* builder, uint32_t text_token_count,
    uint32_t padded_text_token_count, uint32_t llm_feature_count,
    id4_pipeline_program_tensor_t condition,
    id4_pipeline_program_tensor_t weight,
    id4_pipeline_program_tensor_t* out_packed_condition) {
  if (padded_text_token_count < text_token_count ||
      padded_text_token_count % ID4_IDEOGRAM4_DIT_LINEAR_TOKEN_BLOCK != 0) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Ideogram4 condition token capacity %" PRIu32
                            " must cover %" PRIu32
                            " tokens and be a multiple of %u",
                            padded_text_token_count, text_token_count,
...
iree_status_t
id4_ideogram4_dit_program_dispatch_linear_packed_fp8_bf16_compact_rhs_tile(
    id4_pipeline_program_builder_t* builder, iree_string_view_t name,
    uint32_t token_count, uint32_t token_capacity, uint32_t input_size,
    uint32_t output_size, id4_pipeline_program_tensor_t input,
    id4_pipeline_program_tensor_t weight, id4_pipeline_program_tensor_t scale,
...
static iree_status_t id4_ideogram4_dit_program_dispatch_cast(
  ...
  const id4_ideogram4_dit_program_config_value_t config_values[] = {
      {IREE_SV("id4.elementwise.cast.element_count"), element_count},
  };
  char value_buffers[ID4_IDEOGRAM4_DIT_MAX_KERNEL_CONFIG_BINDING_COUNT]
                    [ID4_IDEOGRAM4_DIT_CONFIG_VALUE_BUFFER_CAPACITY];
  id4_pipeline_kernel_config_binding_t
  ...
  return id4_ideogram4_dit_program_dispatch_loom(
      builder, name, IREE_SV("elementwise/cast"), function_name,
      IREE_ARRAYSIZE(config_values), config_bindings, IREE_ARRAYSIZE(bindings),
      bindings);
}
...
static iree_status_t id4_ideogram4_dit_program_dispatch_cast_f32_bf16(
  ...
  return id4_ideogram4_dit_program_dispatch_cast(
      builder, name, IREE_SV("id4_elementwise_cast_f32_bf16"), shape, input,
      output);
}
...
iree_status_t id4_ideogram4_dit_program_dispatch_cast_bf16_f32(
    ...
    id4_pipeline_program_tensor_t output) {
  return id4_ideogram4_dit_program_dispatch_cast(
      builder, name, IREE_SV("id4_elementwise_cast_bf16_f32"), shape, input,
      output);
}
...
static iree_status_t
id4_ideogram4_dit_program_dispatch_linear_bias_packed_fp8_bf16_wmma(
    id4_pipeline_program_builder_t* builder, iree_string_view_t name,
    uint32_t valid_token_count, uint32_t token_capacity, uint32_t input_size,
    uint32_t output_size, id4_pipeline_program_matrix_layout_t output_layout,
    id4_pipeline_program_tensor_t input,
  ...
  if (parameter.storage !=
    ...
    return iree_make_status(
        IREE_STATUS_INVALID_ARGUMENT,
        "Ideogram4 DiT compact FP8 linear-bias parameter has storage %" PRIu32,
...
static iree_status_t
id4_ideogram4_dit_program_dispatch_prelude_image_fp8_bf16_wmma(
    id4_pipeline_program_builder_t* builder, uint32_t image_token_count,
    uint32_t total_token_count, uint32_t output_token_offset,
    uint32_t image_width, uint32_t image_height, uint32_t input_channel_count,
    uint32_t hidden_size, id4_pipeline_program_tensor_t image_tokens,
    ...
    id4_pipeline_program_tensor_t image_indicator_embedding,
    id4_pipeline_program_tensor_t output) {
  id4_pipeline_program_tensor_t packed_image_tokens =
      id4_pipeline_program_tensor_invalid();
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_acquire_tensor(
      builder, IREE_SV("ideogram4.prelude.image_input_packed"),
      ID4_PIPELINE_PROGRAM_DTYPE_BF16,
  ...
  IREE_RETURN_IF_ERROR(
      id4_ideogram4_dit_program_dispatch_prelude_image_pack_f32_bf16(
          builder, image_token_count, image_width, image_height,
          input_channel_count, image_tokens, packed_image_tokens));
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_barrier(
      builder, IREE_SV("ideogram4.prelude.after_image_input_pack")));

  id4_pipeline_program_tensor_t projected_image_tokens =
      id4_pipeline_program_tensor_invalid();
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_acquire_tensor(
      builder, IREE_SV("ideogram4.prelude.image_projected"),
      ID4_PIPELINE_PROGRAM_DTYPE_BF16,
  ...
  IREE_RETURN_IF_ERROR(
      id4_ideogram4_dit_program_dispatch_linear_bias_packed_fp8_bf16_wmma(
          builder, IREE_SV("ideogram4.prelude.image_projection"),
          image_token_count, image_token_count, input_channel_count,
          hidden_size, ID4_PIPELINE_PROGRAM_MATRIX_LAYOUT_COLUMN_MAJOR,
          packed_image_tokens, input_proj, input_proj_bias,
          projected_image_tokens));
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_barrier(
      builder, IREE_SV("ideogram4.prelude.after_image_projection")));

  return id4_ideogram4_dit_program_dispatch_prelude_indicator_bf16_f32(
      builder, image_token_count, total_token_count, output_token_offset,
      hidden_size, projected_image_tokens, image_indicator,
...
static iree_status_t id4_ideogram4_dit_program_dispatch_prelude_image(
    id4_pipeline_program_builder_t* builder,
    id4_ideogram4_dit_activation_format_t activation_format,
    uint32_t image_token_count, uint32_t total_token_count,
    uint32_t output_token_offset, uint32_t image_width, uint32_t image_height,
    ...
    id4_pipeline_program_tensor_t image_indicator_embedding,
    id4_pipeline_program_tensor_t output) {
  const bool use_fp8_bf16_wmma =
      activation_format ==
          ID4_IDEOGRAM4_DIT_ACTIVATION_FORMAT_BF16_LINEAR_INPUT &&
      input_proj.storage ==
          ID4_IDEOGRAM4_DIT_PARAMETER_STORAGE_FP8_E4M3_SCALED &&
      image_token_count >= 32 && image_token_count % 32 == 0 &&
      input_channel_count % 16 == 0 && hidden_size >= 32 &&
      hidden_size % 32 == 0;
  if (use_fp8_bf16_wmma) {
    return id4_ideogram4_dit_program_dispatch_prelude_image_fp8_bf16_wmma(
        builder, image_token_count, total_token_count, output_token_offset,
        image_width, image_height, input_channel_count, hidden_size,
        image_tokens, input_proj, input_proj_bias, image_indicator,
        image_indicator_embedding, output);
  }
  return id4_ideogram4_dit_program_dispatch_prelude_image_scalar(
      builder, image_token_count, total_token_count, output_token_offset,
      image_width, image_height, input_channel_count, hidden_size, image_tokens,
      input_proj, input_proj_bias, image_indicator, image_indicator_embedding,
      output);
}

static bool id4_ideogram4_dit_program_supports_direct_bf16_prelude(
    id4_ideogram4_dit_activation_format_t activation_format,
    bool is_conditioned, uint32_t image_token_count,
    uint32_t input_channel_count, uint32_t llm_feature_count,
    uint32_t hidden_size,
    id4_ideogram4_dit_program_linear_parameter_t input_projection,
    id4_ideogram4_dit_program_linear_parameter_t condition_projection,
    iree_string_view_list_t diagnostic_tap_names) {
  if (activation_format !=
          ID4_IDEOGRAM4_DIT_ACTIVATION_FORMAT_BF16_LINEAR_INPUT ||
      input_projection.storage !=
          ID4_IDEOGRAM4_DIT_PARAMETER_STORAGE_FP8_E4M3_SCALED ||
      image_token_count < ID4_IDEOGRAM4_DIT_LINEAR_WMMA_TOKEN_BLOCK ||
      image_token_count % ID4_IDEOGRAM4_DIT_LINEAR_WMMA_TOKEN_BLOCK != 0 ||
      input_channel_count % ID4_IDEOGRAM4_DIT_LINEAR_TOKEN_BLOCK != 0 ||
      hidden_size < ID4_IDEOGRAM4_DIT_LINEAR_WMMA_OUTPUT_ROW_BLOCK ||
      hidden_size % ID4_IDEOGRAM4_DIT_LINEAR_WMMA_OUTPUT_ROW_BLOCK != 0) {
    return false;
  }
  if (!is_conditioned) return true;
  if (condition_projection.storage !=
          ID4_IDEOGRAM4_DIT_PARAMETER_STORAGE_FP8_E4M3_SCALED ||
      llm_feature_count % ID4_IDEOGRAM4_DIT_LINEAR_TOKEN_BLOCK != 0) {
    return false;
  }
  return !id4_ideogram4_dit_program_has_diagnostic_tap(
...
id4_ideogram4_dit_program_dispatch_attention_materialized_export(
  ...
  const id4_ideogram4_dit_program_config_value_t config_values[] = {
      ...
      {IREE_SV("id4.attention.materialized_wmma.padded_token_count"),
       padded_token_count},
      {IREE_SV("id4.attention.materialized_wmma.query_block_offset"),
       query_block_offset},
      ...
      {IREE_SV("id4.attention.materialized_wmma.attention_head_count"),
       attention_head_count},
      {IREE_SV("id4.attention.materialized_wmma.head_size"), head_size},
  };
  char value_buffers[ID4_IDEOGRAM4_DIT_MAX_KERNEL_CONFIG_BINDING_COUNT]
                    [ID4_IDEOGRAM4_DIT_CONFIG_VALUE_BUFFER_CAPACITY];
  id4_pipeline_kernel_config_binding_t
  ...
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_make_config_bindings(
      ...
      config_bindings));
  return id4_ideogram4_dit_program_dispatch_loom(
      builder, name, IREE_SV("attention/materialized_bf16_wmma"), function_name,
...
id4_ideogram4_dit_program_dispatch_materialized_attention_qk_scores_bf16_f32_wmma(
  ...
  return id4_ideogram4_dit_program_dispatch_attention_materialized_export(
      builder, name, IREE_SV("id4_attention_qk_scores_all_heads_bf16_f32_wmma"),
...
id4_ideogram4_dit_program_dispatch_materialized_attention_softmax_f32_bf16(
  ...
  return id4_ideogram4_dit_program_dispatch_attention_materialized_export(
      builder, name, IREE_SV("id4_attention_softmax_all_heads_f32_bf16"),
      valid_token_count, padded_token_count, query_block_offset,
      query_block_token_count, attention_head_count, head_size,
      IREE_ARRAYSIZE(bindings), bindings);
}
...
id4_ideogram4_dit_program_dispatch_materialized_attention_pv_bf16_bf16_wmma(
  ...
  return id4_ideogram4_dit_program_dispatch_attention_materialized_export(
      builder, name, IREE_SV("id4_attention_pv_all_heads_bf16_bf16_wmma"),
      valid_token_count, padded_token_count, query_block_offset,
      query_block_token_count, attention_head_count, head_size,
      IREE_ARRAYSIZE(bindings), bindings);
}
...
iree_status_t id4_ideogram4_dit_program_dense_bf16(
  ...
  if (options->activation_kind == ID4_IDEOGRAM4_DIT_ACTIVATION_SILU) {
    char linear_operation_name_buffer[ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
    char linear_output_name_buffer[ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
    char after_linear_name_buffer[ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
    char silu_operation_name_buffer[ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
    iree_string_view_t linear_operation_name = iree_string_view_empty();
    iree_string_view_t linear_output_name = iree_string_view_empty();
    iree_string_view_t after_linear_name = iree_string_view_empty();
    iree_string_view_t silu_operation_name = iree_string_view_empty();
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
        options->operation_name, IREE_SV("linear"),
        linear_operation_name_buffer,
        IREE_ARRAYSIZE(linear_operation_name_buffer), &linear_operation_name));
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
        options->output_name, IREE_SV("linear"), linear_output_name_buffer,
        IREE_ARRAYSIZE(linear_output_name_buffer), &linear_output_name));
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
        options->operation_name, IREE_SV("after_linear"),
        after_linear_name_buffer, IREE_ARRAYSIZE(after_linear_name_buffer),
        &after_linear_name));
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
        options->operation_name, IREE_SV("silu"), silu_operation_name_buffer,
        IREE_ARRAYSIZE(silu_operation_name_buffer), &silu_operation_name));

    id4_ideogram4_dit_program_dense_options_t linear_options = *options;
    linear_options.operation_name = linear_operation_name;
    linear_options.output_name = linear_output_name;
    linear_options.activation_kind = ID4_IDEOGRAM4_DIT_ACTIVATION_IDENTITY;
    id4_pipeline_program_tensor_t linear_output =
        id4_pipeline_program_tensor_invalid();
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_dense_bf16(
        builder, &linear_options, &linear_output));
    IREE_RETURN_IF_ERROR(
        id4_ideogram4_dit_program_barrier(builder, after_linear_name));
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_acquire_tensor(
        builder, options->output_name, ID4_PIPELINE_PROGRAM_DTYPE_BF16,
        id4_pipeline_program_make_shape_rank1(options->output_size),
        out_output));
    return id4_ideogram4_dit_program_dispatch_silu_bf16(
        builder, silu_operation_name, options->output_size, linear_output,
        *out_output);
  }
...
static iree_status_t id4_ideogram4_dit_program_dense_bf16_padded_wmma(
    id4_pipeline_program_builder_t* builder,
    const id4_ideogram4_dit_program_dense_options_t* options,
    iree_string_view_t after_output_name,
    id4_pipeline_program_tensor_t* out_output) {
  if (options->activation_kind != ID4_IDEOGRAM4_DIT_ACTIVATION_IDENTITY) {
    return iree_make_status(
        IREE_STATUS_INVALID_ARGUMENT,
        "Ideogram4 DiT padded WMMA dense requires identity activation");
  }
  if (options->input_size == 0 || (options->input_size % 16) != 0) {
    return iree_make_status(
        IREE_STATUS_INVALID_ARGUMENT,
        "Ideogram4 DiT padded WMMA dense input size must be a nonzero "
        "multiple of 16");
  }
  if (options->output_size == 0 || (options->output_size % 32) != 0) {
    return iree_make_status(
        IREE_STATUS_INVALID_ARGUMENT,
        "Ideogram4 DiT padded WMMA dense output size must be a nonzero "
        "multiple of 32");
  }
  ...
  if (weight.storage != ID4_IDEOGRAM4_DIT_PARAMETER_STORAGE_FP8_E4M3_SCALED) {
    return iree_make_status(
        IREE_STATUS_INVALID_ARGUMENT,
        "Ideogram4 DiT padded WMMA dense parameter `%.*s` storage is %" PRIu32,
  ...
  char input_f32_name_buffer[ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
  char input_cast_name_buffer[ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
  char after_input_cast_name_buffer[ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
  char input_pack_name_buffer[ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
  char padded_output_name_buffer[ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
  char wmma_name_buffer[ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
  iree_string_view_t input_f32_name = iree_string_view_empty();
  iree_string_view_t input_cast_name = iree_string_view_empty();
  iree_string_view_t after_input_cast_name = iree_string_view_empty();
  iree_string_view_t input_pack_name = iree_string_view_empty();
  iree_string_view_t padded_output_name = iree_string_view_empty();
  iree_string_view_t wmma_name = iree_string_view_empty();
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
      options->operation_name, IREE_SV("input_f32"), input_f32_name_buffer,
      IREE_ARRAYSIZE(input_f32_name_buffer), &input_f32_name));
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
      options->operation_name, IREE_SV("cast_input_bf16_f32"),
      input_cast_name_buffer, IREE_ARRAYSIZE(input_cast_name_buffer),
  ...
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
      options->operation_name, IREE_SV("after_input_f32"),
      after_input_cast_name_buffer,
      IREE_ARRAYSIZE(after_input_cast_name_buffer), &after_input_cast_name));
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
      options->operation_name, IREE_SV("padded_input"), input_pack_name_buffer,
      IREE_ARRAYSIZE(input_pack_name_buffer), &input_pack_name));
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
      options->output_name, IREE_SV("padded_wmma"), padded_output_name_buffer,
      IREE_ARRAYSIZE(padded_output_name_buffer), &padded_output_name));
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
      options->operation_name, IREE_SV("wmma"), wmma_name_buffer,
  ...
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_acquire_tensor(
      ...
      &input_f32));
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_dispatch_cast_bf16_f32(
      builder, input_cast_name, input_shape, options->input, input_f32));
  IREE_RETURN_IF_ERROR(
      id4_ideogram4_dit_program_barrier(builder, after_input_cast_name));

  const uint32_t token_capacity = 32;
  id4_pipeline_program_tensor_t padded_input =
      id4_pipeline_program_tensor_invalid();
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_pack_linear_input_f32_bf16(
      builder, input_pack_name, 1, token_capacity, options->input_size,
      input_f32, &padded_input));
  id4_pipeline_program_tensor_t padded_output =
      id4_pipeline_program_tensor_invalid();
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_acquire_tensor(
      builder, padded_output_name, ID4_PIPELINE_PROGRAM_DTYPE_BF16,
      id4_pipeline_program_make_shape_rank2(token_capacity,
                                            options->output_size),
      &padded_output));
  IREE_RETURN_IF_ERROR(
      id4_ideogram4_dit_program_dispatch_linear_bias_packed_fp8_bf16_wmma(
          builder, wmma_name, 1, token_capacity, options->input_size,
          options->output_size, ID4_PIPELINE_PROGRAM_MATRIX_LAYOUT_ROW_MAJOR,
          padded_input, weight, bias, padded_output));
  IREE_RETURN_IF_ERROR(
      id4_ideogram4_dit_program_barrier(builder, after_output_name));

  const id4_pipeline_program_subview_tensor_options_t subview_options = {
      .structure_size = sizeof(subview_options),
      .name = options->output_name,
      .source = padded_output,
      .source_byte_offset = 0,
      .shape = id4_pipeline_program_make_shape_rank1(options->output_size),
  };
  return id4_pipeline_program_subview_tensor(builder, &subview_options,
                                             out_output);
}
...
static iree_status_t id4_ideogram4_dit_program_author_final_output(
  ...
  const bool use_fp8_wmma_final_projection =
      !f32_canonical_activations &&
      final_linear_weight.storage ==
          ID4_IDEOGRAM4_DIT_PARAMETER_STORAGE_FP8_E4M3_SCALED &&
      image_token_count >= 32 && image_token_count % 32 == 0 &&
      hidden_size % 16 == 0 && input_channel_count >= 32 &&
      input_channel_count % 32 == 0;
  const bool use_packed_final_projection =
      use_bf16_wmma_final_projection || use_fp8_wmma_final_projection;
  ...
  id4_pipeline_program_tensor_t final_norm_packed =
      id4_pipeline_program_tensor_invalid();
  if (f32_canonical_activations || !use_packed_final_projection ||
      tap_final_norm) {
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_acquire_tensor(
  ...
  if (use_packed_final_projection) {
    ...
    if (use_fp8_wmma_final_projection) {
      IREE_RETURN_IF_ERROR(
          id4_ideogram4_dit_program_dispatch_linear_bias_packed_fp8_bf16_wmma(
              builder, projected_dispatch_name, image_token_count,
              image_token_count, hidden_size, input_channel_count,
              ID4_PIPELINE_PROGRAM_MATRIX_LAYOUT_ROW_MAJOR, final_norm_packed,
              final_linear_weight, final_linear_bias, projected_packed));
    } else {
      IREE_RETURN_IF_ERROR(
          id4_ideogram4_dit_program_dispatch_linear_bias_packed_bf16_bf16_wmma(
              builder, projected_dispatch_name, image_token_count, hidden_size,
              input_channel_count, final_norm_packed,
              final_linear_weight.weight, final_linear_bias, projected_packed));
    }
    IREE_RETURN_IF_ERROR(
...
iree_status_t id4_ideogram4_dit_program_author_forward(
  ...
  const bool f32_canonical_activations =
      options->activation_format ==
      ID4_IDEOGRAM4_DIT_ACTIVATION_FORMAT_F32_CANONICAL;
  const bool use_compact_fp8_linear_weights =
      id4_ideogram4_dit_program_generic_linear_weight_execution_format(
          options->weight_execution_format) ==
  ...
  char
      prelude_hidden_bf16_name_buffer[ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
  char prelude_hidden_cast_f32_name_buffer
      [ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
  char after_prelude_hidden_round_name_buffer
      [ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
  char timestep_embedding_f32_name_buffer
      [ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
  char timestep_embedding_cast_name_buffer
      [ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
  char after_timestep_embedding_cast_name_buffer
      [ID4_IDEOGRAM4_DIT_FORMAT_BUFFER_CAPACITY];
  ...
  iree_string_view_t prelude_hidden_bf16_name = iree_string_view_empty();
  ...
  iree_string_view_t timestep_embedding_f32_name = iree_string_view_empty();
  iree_string_view_t timestep_embedding_cast_name = iree_string_view_empty();
  iree_string_view_t after_timestep_embedding_cast_name =
  ...
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
      prelude_hidden_name, IREE_SV("input_bf16"),
      prelude_hidden_bf16_name_buffer,
      IREE_ARRAYSIZE(prelude_hidden_bf16_name_buffer),
      &prelude_hidden_bf16_name));
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
  ...
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
      timestep_embedding_name, IREE_SV("f32"),
      timestep_embedding_f32_name_buffer,
      IREE_ARRAYSIZE(timestep_embedding_f32_name_buffer),
      &timestep_embedding_f32_name));
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
      timestep_embedding_name, IREE_SV("cast_bf16"),
      timestep_embedding_cast_name_buffer,
      IREE_ARRAYSIZE(timestep_embedding_cast_name_buffer),
      &timestep_embedding_cast_name));
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
      timestep_embedding_name, IREE_SV("after_cast_bf16"),
      after_timestep_embedding_cast_name_buffer,
      IREE_ARRAYSIZE(after_timestep_embedding_cast_name_buffer),
      &after_timestep_embedding_cast_name));
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_format_child_name(
  ...
  const bool tap_timestep_embedding =
      id4_ideogram4_dit_program_has_diagnostic_tap(
          options->diagnostic_tap_names, timestep_embedding_name);
  ...
  const bool use_direct_bf16_prelude =
      id4_ideogram4_dit_program_supports_direct_bf16_prelude(
          options->activation_format, is_conditioned, image_token_count,
          input_channel_count, llm_feature_count, hidden_size, input_proj,
          llm_cond_proj, options->diagnostic_tap_names);

  id4_pipeline_program_tensor_t prelude_hidden =
      id4_pipeline_program_tensor_invalid();
  id4_pipeline_program_tensor_t prelude_hidden_producer_output =
      id4_pipeline_program_tensor_invalid();
  iree_string_view_t prelude_hidden_producer_name = prelude_hidden_raw_name;
  id4_pipeline_program_dtype_t prelude_hidden_producer_dtype =
      ID4_PIPELINE_PROGRAM_DTYPE_F32;
  id4_pipeline_program_shape_t prelude_hidden_producer_shape = hidden_shape;
  if (f32_canonical_activations) {
    prelude_hidden_producer_name = prelude_hidden_name;
  } else if (use_direct_bf16_prelude) {
    prelude_hidden_producer_name = prelude_hidden_bf16_name;
    prelude_hidden_producer_dtype = ID4_PIPELINE_PROGRAM_DTYPE_BF16;
    prelude_hidden_producer_shape = token_major_hidden_shape;
  }
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_acquire_tensor(
      builder, prelude_hidden_producer_name, prelude_hidden_producer_dtype,
      prelude_hidden_producer_shape, &prelude_hidden_producer_output));
  if (f32_canonical_activations) {
    prelude_hidden = prelude_hidden_producer_output;
  }
  id4_pipeline_program_tensor_t timestep_embedding_f32 =
      id4_pipeline_program_tensor_invalid();
  IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_acquire_tensor(
      builder,
      f32_canonical_activations ? timestep_embedding_name
                                : timestep_embedding_f32_name,
      ID4_PIPELINE_PROGRAM_DTYPE_F32, hidden_vector_shape,
      &timestep_embedding_f32));

  if (use_direct_bf16_prelude) {
    const uint32_t condition_token_capacity =
        id4_ideogram4_dit_program_ceil_div_u32(
            text_token_count, ID4_IDEOGRAM4_DIT_LINEAR_WMMA_TOKEN_BLOCK) *
        ID4_IDEOGRAM4_DIT_LINEAR_WMMA_TOKEN_BLOCK;
    id4_pipeline_program_tensor_t packed_condition =
        id4_pipeline_program_tensor_invalid();
    if (is_conditioned) {
      IREE_RETURN_IF_ERROR(
          id4_ideogram4_dit_program_dispatch_condition_rmsnorm_pack(
              builder, text_token_count, condition_token_capacity,
              llm_feature_count, condition, llm_cond_norm_weight,
              &packed_condition));
    }
    ...
    IREE_RETURN_IF_ERROR(
        id4_ideogram4_dit_program_dispatch_prelude_image_pack_f32_bf16(
            builder, image_token_count,
            (uint32_t)options->request.latent_shape.dims[0],
            (uint32_t)options->request.latent_shape.dims[1],
            input_channel_count, x, packed_image_tokens));
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_barrier(
        builder, IREE_SV("ideogram4.prelude.after_input_packs")));
    ...
    if (is_conditioned &&
      ...
      IREE_RETURN_IF_ERROR(
          id4_ideogram4_dit_program_tap_linear_input_bf16_as_f32(
              builder, IREE_SV("ideogram4.cond.prelude.llm_cond_norm"),
              text_token_count, condition_token_capacity, llm_feature_count,
              packed_condition));
    }
    ...
    if (is_conditioned) {
      IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_acquire_tensor(
          builder, IREE_SV("ideogram4.cond.prelude.llm_cond_proj.biased"),
          ID4_PIPELINE_PROGRAM_DTYPE_BF16,
          id4_pipeline_program_make_shape_rank2(condition_token_capacity,
                                                hidden_size),
          &projected_condition));
      IREE_RETURN_IF_ERROR(
          id4_ideogram4_dit_program_dispatch_linear_bias_packed_fp8_bf16_wmma(
              builder, IREE_SV("ideogram4.cond.prelude.llm_cond_proj.wmma"),
              text_token_count, condition_token_capacity, llm_feature_count,
              hidden_size, ID4_PIPELINE_PROGRAM_MATRIX_LAYOUT_ROW_MAJOR,
              packed_condition, llm_cond_proj, llm_cond_proj_bias,
              projected_condition));
    }

    id4_pipeline_program_tensor_t projected_image =
        id4_pipeline_program_tensor_invalid();
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_acquire_tensor(
        builder, IREE_SV("ideogram4.prelude.image_projected"),
        ID4_PIPELINE_PROGRAM_DTYPE_BF16,
    ...
    IREE_RETURN_IF_ERROR(
        id4_ideogram4_dit_program_dispatch_linear_bias_packed_fp8_bf16_wmma(
            ...
            image_token_count, image_token_count, input_channel_count,
            hidden_size, ID4_PIPELINE_PROGRAM_MATRIX_LAYOUT_ROW_MAJOR,
            packed_image_tokens, input_proj, input_proj_bias, projected_image));
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_barrier(
        builder, IREE_SV("ideogram4.prelude.after_input_projections")));

    if (is_conditioned) {
      IREE_RETURN_IF_ERROR(
          id4_ideogram4_dit_program_dispatch_prelude_indicator_bf16(
              builder,
              IREE_SV("ideogram4.cond.prelude.llm_cond_proj.bias_indicator"),
              text_token_count, condition_token_capacity, total_token_count, 0,
              hidden_size, projected_condition, image_indicator,
              image_indicator_embedding, prelude_hidden_producer_output));
    }
    IREE_RETURN_IF_ERROR(
        id4_ideogram4_dit_program_dispatch_prelude_indicator_bf16(
            builder, IREE_SV("ideogram4.prelude.image_indicator"),
            image_token_count, image_token_count, total_token_count,
            text_token_count, hidden_size, projected_image, image_indicator,
            image_indicator_embedding, prelude_hidden_producer_output));
  } else if (is_conditioned) {
    ...
    if (needs_canonical_condition_norm) {
      ...
      IREE_RETURN_IF_ERROR(
          id4_ideogram4_dit_program_dispatch_condition_rmsnorm_pack(
              builder, text_token_count, padded_text_token_count,
              llm_feature_count, condition, llm_cond_norm_weight,
              &packed_condition));
      IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_barrier(
  ...
  if (!use_direct_bf16_prelude) {
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_dispatch_prelude_image(
        builder, options->activation_format, image_token_count,
        total_token_count, text_token_count,
        (uint32_t)options->request.latent_shape.dims[0],
  ...
  id4_pipeline_program_tensor_t timestep_embedding = timestep_embedding_f32;
  if (f32_canonical_activations) {
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_tap(
        builder, timestep_embedding_name, timestep_embedding));
  } else {
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_acquire_tensor(
        builder, timestep_embedding_name, ID4_PIPELINE_PROGRAM_DTYPE_BF16,
        hidden_vector_shape, &timestep_embedding));
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_dispatch_cast_f32_bf16(
        builder, timestep_embedding_cast_name, hidden_vector_shape,
        timestep_embedding_f32, timestep_embedding));
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_barrier(
        builder, after_timestep_embedding_cast_name));
    if (tap_timestep_embedding) {
      IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_tap_bf16_as_f32(
          builder, timestep_embedding_name, hidden_vector_shape,
          timestep_embedding));
    }
  }
  ...
  if (!f32_canonical_activations && tap_timestep_mlp_in) {
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_tap_bf16_as_f32(
  ...
  if (f32_canonical_activations) {
    ...
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_barrier(
        builder, after_timestep_mlp_out_name));
  } else if (use_compact_fp8_linear_weights) {
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_dense_bf16_padded_wmma(
        builder, &mlp_out_options, after_timestep_mlp_out_name,
        &timestep_mlp_out));
  } else {
    IREE_RETURN_IF_ERROR(id4_ideogram4_dit_program_dense_bf16(
        builder, &mlp_out_options, &timestep_mlp_out));
