...
#define ID4_QWEN3_VL_CONDITION_STAGE_BINDING_COUNT 4
#define ID4_QWEN3_VL_CONDITION_STAGE_SELECTED_HIDDEN_STATES_BINDING_SLOT 0
#define ID4_QWEN3_VL_CONDITION_STAGE_TOKEN_WEIGHTS_BINDING_SLOT 1
#define ID4_QWEN3_VL_CONDITION_STAGE_CONDITION_BINDING_SLOT 2
#define ID4_QWEN3_VL_CONDITION_STAGE_LOCAL_BINDING_SLOT 3
#define ID4_QWEN3_VL_CONDITION_STAGE_MAX_CONDITION_ELEMENT_COUNT \
  ((uint64_t)1048576)
#define ID4_QWEN3_VL_CONDITION_STAGE_STATS_BYTE_LENGTH 8

typedef struct id4_qwen3_vl_condition_stage_t {
  ...
  bool is_loaded;
} id4_qwen3_vl_condition_stage_t;

typedef struct id4_qwen3_vl_condition_stage_bundle_payload_t {
  // Prepared kernel executable retained for command-buffer validity.
  id4_pipeline_kernel_executable_t* executable;
  // Prepared reusable region issued by the Qwen3-VL condition stage.
  ...
  iree_hal_buffer_binding_t
      bindings[ID4_QWEN3_VL_CONDITION_STAGE_BINDING_COUNT];
} id4_qwen3_vl_condition_stage_bundle_payload_t;

static id4_qwen3_vl_condition_stage_t* id4_qwen3_vl_condition_stage_cast(
    id4_pipeline_stage_t* base_stage) {
  return (id4_qwen3_vl_condition_stage_t*)base_stage;
}

static const id4_qwen3_vl_condition_stage_t*
id4_qwen3_vl_condition_stage_const_cast(
    const id4_pipeline_stage_t* base_stage) {
  return (const id4_qwen3_vl_condition_stage_t*)base_stage;
}

static iree_status_t id4_qwen3_vl_condition_stage_validate_options_size(
...
static iree_status_t id4_qwen3_vl_condition_stage_copy_string(
...
static iree_status_t id4_qwen3_vl_condition_stage_copy_bytes(
...
static void id4_qwen3_vl_condition_stage_free_string(
    iree_string_view_t* value, iree_allocator_t host_allocator) {
  if (!value) return;
...
static void id4_qwen3_vl_condition_stage_free_bytes(
    iree_const_byte_span_t* value, iree_allocator_t host_allocator) {
  if (!value) return;
  iree_allocator_free(host_allocator, (void*)value->data);
  memset(value, 0, sizeof(*value));
...
static uint64_t id4_qwen3_vl_condition_stage_condition_element_count(
    const id4_qwen3_vl_condition_stage_t* stage) {
  return (uint64_t)stage->hidden_row_count * stage->token_count;
}

static iree_status_t id4_qwen3_vl_condition_stage_condition_byte_length(
    uint64_t element_count, iree_device_size_t* out_byte_length) {
  if (!iree_device_size_checked_mul(
          element_count, ID4_QWEN3_VL_CONDITION_STAGE_F32_ELEMENT_BYTE_LENGTH,
          out_byte_length)) {
...
static iree_status_t id4_qwen3_vl_condition_stage_token_weights_byte_length(
    uint32_t token_count, iree_device_size_t* out_byte_length) {
  if (!iree_device_size_checked_mul(
          token_count, ID4_QWEN3_VL_CONDITION_STAGE_F32_ELEMENT_BYTE_LENGTH,
          out_byte_length)) {
    return iree_make_status(IREE_STATUS_OUT_OF_RANGE,
...
static iree_status_t id4_qwen3_vl_condition_stage_workgroups_x(
...
static iree_status_t id4_qwen3_vl_condition_stage_validate_create_options(
    const id4_qwen3_vl_condition_stage_create_options_t* options) {
  if (!options) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Qwen3-VL condition stage create options are "
                            "required");
  }
  IREE_RETURN_IF_ERROR(id4_qwen3_vl_condition_stage_validate_options_size(
      options->structure_size, sizeof(*options),
      IREE_SV("Qwen3-VL condition stage create")));
  if (options->next) {
    return iree_make_status(
        IREE_STATUS_UNIMPLEMENTED,
        "Qwen3-VL condition stage create extension structures are not "
        "supported");
  }
  if (!options->services.device_group) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Qwen3-VL condition stage device group is "
                            "required");
  }
  if (iree_string_view_is_empty(options->source_identifier)) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Qwen3-VL condition stage source identifier is "
                            "required");
  }
  if (iree_string_view_is_empty(options->module_name)) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Qwen3-VL condition stage module name is required");
  }
  if (iree_string_view_is_empty(options->executable_identifier)) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Qwen3-VL condition stage executable identifier is "
                            "required");
  }
  if (iree_string_view_is_empty(options->apply_token_weights_function_name)) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Qwen3-VL condition stage apply-token-weights "
                            "function name is required");
  }
  if (iree_string_view_is_empty(
          options->normalize_token_weights_function_name)) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Qwen3-VL condition stage normalize-token-weights "
                            "function name is required");
  }
  ...
  if (element_count >
      ID4_QWEN3_VL_CONDITION_STAGE_MAX_CONDITION_ELEMENT_COUNT) {
    return iree_make_status(
  ...
  IREE_RETURN_IF_ERROR(id4_qwen3_vl_condition_stage_condition_byte_length(
      element_count, &byte_length));
  return id4_qwen3_vl_condition_stage_token_weights_byte_length(
      options->token_count, &byte_length);
}

static iree_status_t id4_qwen3_vl_condition_stage_format_u32(
...
id4_qwen3_vl_condition_stage_lifecycle_event(iree_string_view_t key,
                                             iree_string_view_t message) {
  id4_pipeline_diagnostic_event_t event = {
      // Lifecycle event emitted by the Qwen3-VL condition stage.
      .kind = ID4_PIPELINE_DIAGNOSTIC_EVENT_KIND_LIFECYCLE,
      // Stable stage name used across Qwen3-VL condition diagnostics.
      .stage_name = IREE_SV("qwen3_vl.condition"),
...
static iree_status_t id4_qwen3_vl_condition_stage_emit_lifecycle(
    id4_pipeline_diagnostics_sink_t* diagnostics_sink, iree_string_view_t key,
    iree_string_view_t message) {
  id4_pipeline_diagnostic_event_t event =
      id4_qwen3_vl_condition_stage_lifecycle_event(key, message);
  return id4_pipeline_diagnostics_emit(diagnostics_sink, &event);
}

static id4_pipeline_tensor_shape_t
id4_qwen3_vl_condition_stage_make_condition_shape(
    const id4_qwen3_vl_condition_stage_t* stage) {
...
static id4_pipeline_tensor_shape_t
id4_qwen3_vl_condition_stage_make_token_shape(
    const id4_qwen3_vl_condition_stage_t* stage) {
  id4_pipeline_tensor_shape_t shape;
  memset(&shape, 0, sizeof(shape));
  shape.rank = 1;
...
static id4_pipeline_tensor_shape_t
id4_qwen3_vl_condition_stage_make_stats_shape(void) {
  id4_pipeline_tensor_shape_t shape;
  memset(&shape, 0, sizeof(shape));
  shape.rank = 1;
  shape.dims[0] = 2;
...
static iree_status_t id4_qwen3_vl_condition_stage_author_region(
    id4_qwen3_vl_condition_stage_t* stage,
  ...
  const uint64_t element_count =
      id4_qwen3_vl_condition_stage_condition_element_count(stage);
  ...
  IREE_RETURN_IF_ERROR(id4_qwen3_vl_condition_stage_token_weights_byte_length(
      stage->token_count, &token_weights_byte_length));

  id4_pipeline_tensor_shape_t condition_shape =
      id4_qwen3_vl_condition_stage_make_condition_shape(stage);
  id4_pipeline_tensor_shape_t token_shape =
      id4_qwen3_vl_condition_stage_make_token_shape(stage);
  ...
  selected_import.layout.alignment =
      ID4_QWEN3_VL_CONDITION_STAGE_F32_ELEMENT_BYTE_LENGTH;
  selected_import.binding_slot =
      ID4_QWEN3_VL_CONDITION_STAGE_SELECTED_HIDDEN_STATES_BINDING_SLOT;
  ...
  token_weights_import.binding_slot =
      ID4_QWEN3_VL_CONDITION_STAGE_TOKEN_WEIGHTS_BINDING_SLOT;
  ...
  condition_import.layout.alignment =
      ID4_QWEN3_VL_CONDITION_STAGE_F32_ELEMENT_BYTE_LENGTH;
  condition_import.binding_slot =
      ID4_QWEN3_VL_CONDITION_STAGE_CONDITION_BINDING_SLOT;
  ...
  stats_layout.shape = id4_qwen3_vl_condition_stage_make_stats_shape();
  stats_layout.byte_length = ID4_QWEN3_VL_CONDITION_STAGE_STATS_BYTE_LENGTH;
  ...
  IREE_RETURN_IF_ERROR(id4_qwen3_vl_condition_stage_workgroups_x(
...
static iree_status_t id4_qwen3_vl_condition_stage_dry_run_region(
    id4_qwen3_vl_condition_stage_t* stage,
...
static iree_status_t id4_qwen3_vl_condition_stage_format_specialization_key(
    const id4_qwen3_vl_condition_stage_t* stage, char* buffer,
...
static void id4_qwen3_vl_condition_stage_make_tensor_buffer_params(
...
static iree_status_t id4_qwen3_vl_condition_stage_create_plan(
  ...
  IREE_RETURN_IF_ERROR(id4_qwen3_vl_condition_stage_format_u32(
  ...
  IREE_RETURN_IF_ERROR(id4_qwen3_vl_condition_stage_format_specialization_key(
  ...
  id4_qwen3_vl_condition_stage_make_tensor_buffer_params(
  ...
  id4_pipeline_memory_slab_plan_t memory_slabs[] = {
      {
          ...
          .name = IREE_SV("qwen3_vl.condition.selected_hidden_states"),
          ...
          .alignment = ID4_QWEN3_VL_CONDITION_STAGE_F32_ELEMENT_BYTE_LENGTH,
      ...
      },
      {
          ...
          .name = IREE_SV("qwen3_vl.condition.token_weights"),
          // Plan-local placement identifier.
          .placement_id = 0,
      ...
      },
      {
          ...
          .name = IREE_SV("qwen3_vl.condition.output"),
          // Plan-local placement identifier.
          .placement_id = 0,
          // Issue-time binding-table slot for the condition tensor.
          .binding_slot = ID4_QWEN3_VL_CONDITION_STAGE_CONDITION_BINDING_SLOT,
      ...
      },
      {
          ...
          .name = IREE_SV("qwen3_vl.condition.local"),
          // Plan-local placement identifier.
          .placement_id = 0,
          // Issue-time binding-table slot for the local transient slab.
          .binding_slot = ID4_QWEN3_VL_CONDITION_STAGE_LOCAL_BINDING_SLOT,
  ...
  region.name = IREE_SV("qwen3_vl.condition.forward");
  region.placement_id = 0;
  region.binding_capacity = ID4_QWEN3_VL_CONDITION_STAGE_BINDING_COUNT;
  region.local_binding_slot = ID4_QWEN3_VL_CONDITION_STAGE_LOCAL_BINDING_SLOT;
  ...
  id4_pipeline_diagnostic_tap_plan_t taps[] = {
      {
          ...
          .name = IREE_SV("qwen3_vl.condition.selected_hidden_states.before"),
      ...
      },
      {
          ...
          .name = IREE_SV("qwen3_vl.condition.token_weights.before"),
          // Region containing the tapped value.
          .region_id = 0,
      ...
      },
      {
          ...
          .name = IREE_SV("qwen3_vl.condition.output.after"),
          // Region containing the tapped value.
          .region_id = 0,
  ...
  create_options.stage_name = IREE_SV("qwen3_vl.condition");
...
static iree_status_t id4_qwen3_vl_condition_stage_prepare_kernel_executable(
    id4_qwen3_vl_condition_stage_t* stage,
  ...
  if (!stage->kernel_cache) {
    return iree_make_status(
        ...
        "Qwen3-VL condition stage kernel cache is required for "
        "preparation");
  }
  if (!stage->base.services.executable_cache) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Qwen3-VL condition stage HAL executable cache is "
                            "required for preparation");
  }
  if (!stage->source_contents.data || stage->source_contents.data_length == 0) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Qwen3-VL condition stage source contents are "
                            "required for preparation");
  }
...
id4_qwen3_vl_condition_stage_allocate_selected_hidden_states_buffer(
...
static iree_status_t id4_qwen3_vl_condition_stage_allocate_token_weights_buffer(
    iree_hal_device_t* device, iree_hal_queue_affinity_t queue_affinity,
    iree_device_size_t byte_length, iree_hal_buffer_t** out_buffer) {
  iree_hal_buffer_params_t params;
  id4_qwen3_vl_condition_stage_make_tensor_buffer_params(
...
static iree_status_t id4_qwen3_vl_condition_stage_allocate_condition_buffer(
    iree_hal_device_t* device, iree_hal_queue_affinity_t queue_affinity,
    iree_device_size_t byte_length, iree_hal_buffer_t** out_buffer) {
  iree_hal_buffer_params_t params;
  id4_qwen3_vl_condition_stage_make_tensor_buffer_params(
...
static iree_status_t id4_qwen3_vl_condition_stage_record_region(
    id4_qwen3_vl_condition_stage_t* stage,
    iree_hal_device_group_t* device_group, iree_host_size_t device_index,
    iree_hal_queue_affinity_t queue_affinity,
    id4_pipeline_kernel_executable_t* executable,
  ...
  if (!device) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Qwen3-VL condition stage placement device is "
                            "required");
  }
  ...
  iree_status_t status = iree_hal_command_buffer_create(
      ...
      ID4_QWEN3_VL_CONDITION_STAGE_BINDING_COUNT, &command_buffer);
  if (iree_status_is_ok(status)) {
  ...
  if (iree_status_is_ok(status)) {
    ...
    builder_options.binding_capacity =
        ID4_QWEN3_VL_CONDITION_STAGE_BINDING_COUNT;
    builder_options.local_binding_slot =
        ID4_QWEN3_VL_CONDITION_STAGE_LOCAL_BINDING_SLOT;
...
static void id4_qwen3_vl_condition_stage_bundle_payload_destroy(
    id4_pipeline_bundle_t* bundle, void* raw_payload) {
  (void)bundle;
  id4_qwen3_vl_condition_stage_bundle_payload_t* payload =
      (id4_qwen3_vl_condition_stage_bundle_payload_t*)raw_payload;
...
static void id4_qwen3_vl_condition_stage_destroy(
    id4_pipeline_stage_t* base_stage) {
  id4_qwen3_vl_condition_stage_t* stage =
      id4_qwen3_vl_condition_stage_cast(base_stage);
  iree_allocator_t host_allocator = stage->host_allocator;
  id4_pipeline_kernel_cache_release(stage->kernel_cache);
  id4_qwen3_vl_condition_stage_free_string(
      &stage->normalize_token_weights_function_name, host_allocator);
  id4_qwen3_vl_condition_stage_free_string(
      &stage->apply_token_weights_function_name, host_allocator);
  id4_qwen3_vl_condition_stage_free_string(&stage->executable_identifier,
                                           host_allocator);
  id4_qwen3_vl_condition_stage_free_string(&stage->module_name, host_allocator);
  id4_qwen3_vl_condition_stage_free_bytes(&stage->source_contents,
                                          host_allocator);
  id4_qwen3_vl_condition_stage_free_string(&stage->source_identifier,
                                           host_allocator);
  id4_pipeline_stage_deinitialize(base_stage);
  iree_allocator_free(host_allocator, stage);
}

static iree_status_t id4_qwen3_vl_condition_stage_load(
    id4_pipeline_stage_t* base_stage,
    const id4_pipeline_stage_load_options_t* options) {
  id4_qwen3_vl_condition_stage_t* stage =
      id4_qwen3_vl_condition_stage_cast(base_stage);
  stage->is_loaded = true;
  return id4_qwen3_vl_condition_stage_emit_lifecycle(
      options->diagnostics_sink, IREE_SV("stage.load"),
      IREE_SV("loaded Qwen3-VL condition stage"));
}

static iree_status_t id4_qwen3_vl_condition_stage_plan(
    id4_pipeline_stage_t* base_stage,
    const id4_pipeline_stage_plan_options_t* options,
    id4_pipeline_plan_t** out_plan) {
  const id4_qwen3_vl_condition_stage_t* stage =
      id4_qwen3_vl_condition_stage_const_cast(base_stage);
  if (!stage->is_loaded) {
    return iree_make_status(IREE_STATUS_FAILED_PRECONDITION,
                            "Qwen3-VL condition stage must be loaded before "
                            "planning");
  }
  return id4_qwen3_vl_condition_stage_create_plan(
      options, stage->host_allocator, out_plan, base_stage);
}

static iree_status_t id4_qwen3_vl_condition_stage_validate_prepare_inputs(
    const id4_pipeline_plan_t* plan,
    const id4_pipeline_stage_prepare_options_t* options) {
  if (!iree_string_view_equal(id4_pipeline_plan_stage_name(plan),
                              IREE_SV("qwen3_vl.condition"))) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Qwen3-VL condition stage prepare requires a "
                            "Qwen3-VL condition plan");
  }
  if (id4_pipeline_plan_placement_count(plan) != 1) {
    return iree_make_status(IREE_STATUS_INVALID_ARGUMENT,
                            "Qwen3-VL condition stage plan must have one "
                            "placement");
  }
...
static iree_status_t id4_qwen3_vl_condition_stage_prepare(
  ...
  IREE_RETURN_IF_ERROR(
      id4_qwen3_vl_condition_stage_validate_prepare_inputs(plan, options));
  ...
  iree_status_t status = id4_qwen3_vl_condition_stage_prepare_kernel_executable(
  ...
  if (iree_status_is_ok(status)) {
    status = id4_qwen3_vl_condition_stage_allocate_token_weights_buffer(
        device, placement->queue_affinity, token_weights_byte_length,
        &token_weights_buffer);
  }
  if (iree_status_is_ok(status)) {
    status = id4_qwen3_vl_condition_stage_allocate_condition_buffer(
        device, placement->queue_affinity, condition_byte_length,
        &condition_buffer);
  }
  if (iree_status_is_ok(status)) {
  ...
  if (iree_status_is_ok(status)) {
    status = id4_qwen3_vl_condition_stage_record_region(
  ...
  if (iree_status_is_ok(status)) {
    ...
    create_options.payload_size =
        sizeof(id4_qwen3_vl_condition_stage_bundle_payload_t);
    create_options.payload_alignment =
        iree_alignof(id4_qwen3_vl_condition_stage_bundle_payload_t);
    create_options.payload_destroy =
        id4_qwen3_vl_condition_stage_bundle_payload_destroy;
  ...
  if (iree_status_is_ok(status)) {
    ...
    payload->bindings[ID4_QWEN3_VL_CONDITION_STAGE_CONDITION_BINDING_SLOT] =
        (iree_hal_buffer_binding_t){
    ...
    payload->bindings[ID4_QWEN3_VL_CONDITION_STAGE_TOKEN_WEIGHTS_BINDING_SLOT] =
        (iree_hal_buffer_binding_t){
    ...
    payload->bindings[ID4_QWEN3_VL_CONDITION_STAGE_LOCAL_BINDING_SLOT] =
        (iree_hal_buffer_binding_t){
  ...
  if (iree_status_is_ok(status)) {
    status = id4_qwen3_vl_condition_stage_emit_lifecycle(
        options->diagnostics_sink, IREE_SV("stage.prepare"),
        IREE_SV("prepared Qwen3-VL condition bundle"));
  }
  if (iree_status_is_ok(status)) {
    *out_bundle = bundle;
  } else {
...
static iree_status_t id4_qwen3_vl_condition_stage_issue(
  ...
  if (!payload || !payload->prepared_region) {
    return iree_make_status(IREE_STATUS_FAILED_PRECONDITION,
                            "Qwen3-VL condition bundle payload is not "
                            "prepared");
  }

  IREE_RETURN_IF_ERROR(id4_qwen3_vl_condition_stage_emit_lifecycle(
      options->diagnostics_sink, IREE_SV("stage.issue"),
      IREE_SV("issued Qwen3-VL condition bundle")));
  ...
  if (!iree_host_size_checked_add(readiness_list.count,
    ...
    return iree_make_status(
        IREE_STATUS_OUT_OF_RANGE,
        "Qwen3-VL condition stage wait list count overflow");
  }
  ...
  iree_hal_buffer_binding_table_t binding_table = {
      ...
      .count = ID4_QWEN3_VL_CONDITION_STAGE_BINDING_COUNT,
...
static const id4_pipeline_stage_vtable_t id4_qwen3_vl_condition_stage_vtable = {
    // Destroys the Qwen3-VL condition stage.
    id4_qwen3_vl_condition_stage_destroy,
    // Loads immutable Qwen3-VL condition stage state.
    id4_qwen3_vl_condition_stage_load,
    // Builds an inspectable Qwen3-VL condition execution plan.
    id4_qwen3_vl_condition_stage_plan,
    // Prepares a reusable Qwen3-VL condition execution bundle.
    id4_qwen3_vl_condition_stage_prepare,
    // Issues one Qwen3-VL condition bundle execution.
    id4_qwen3_vl_condition_stage_issue,
};
...
iree_status_t id4_qwen3_vl_condition_stage_create(
  ...
  *out_stage = NULL;
  IREE_RETURN_IF_ERROR(
      id4_qwen3_vl_condition_stage_validate_create_options(options));

  id4_qwen3_vl_condition_stage_t* stage = NULL;
  ...
  if (iree_status_is_ok(status)) {
    status = id4_pipeline_stage_initialize(&id4_qwen3_vl_condition_stage_vtable,
  ...
  if (iree_status_is_ok(status)) {
    status = id4_qwen3_vl_condition_stage_copy_string(
        options->source_identifier, host_allocator, &stage->source_identifier);
  }
  if (iree_status_is_ok(status)) {
    status = id4_qwen3_vl_condition_stage_copy_bytes(
  ...
  if (iree_status_is_ok(status)) {
    status = id4_qwen3_vl_condition_stage_copy_string(
        options->executable_identifier, host_allocator,
...
id4_qwen3_vl_condition_stage_bundle_token_weights_byte_length(
  ...
  const id4_qwen3_vl_condition_stage_bundle_payload_t* payload =
      (const id4_qwen3_vl_condition_stage_bundle_payload_t*)
