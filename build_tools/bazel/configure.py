...
def parse_arguments(argv: list[str] | None = None) -> argparse.Namespace:
  ...
  python build_tools/bazel/configure.py --//runtime/config/hal:drivers=amdgpu,local-task,null --repo_env=IREE_ROCM_PATH=/opt/rocm
