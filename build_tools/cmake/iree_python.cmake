...
function(_iree_py_library_source_target OUTPUT_TARGET SOURCE_FILE)
  ...
  if(NOT TARGET "${_SOURCE_TARGET}")
    ...
    if(WIN32)
      # Creating symlinks requires Developer Mode or elevated privileges on
      # Windows. A copy has the same semantics for build-tree Python sources
      # and remains dependency-tracked by the custom command.
      set(_SOURCE_MATERIALIZE_COMMAND copy_if_different)
    else()
      set(_SOURCE_MATERIALIZE_COMMAND create_symlink)
    endif()
    add_custom_command(
      OUTPUT
        "${_SOURCE_BIN_PATH}"
      ...
      COMMAND
        ${CMAKE_COMMAND} -E ${_SOURCE_MATERIALIZE_COMMAND}
