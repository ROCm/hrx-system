...
active.""",
  ...
  python dev.py bazel configure --//runtime/config/hal:drivers=amdgpu,local-task --repo_env=IREE_ROCM_PATH=/opt/rocm
...
iree-bazel-configure --//runtime/config/hal:drivers=amdgpu,local-task --repo_env=IREE_ROCM_PATH=/opt/rocm --repo_env=IREE_ROCM_DEPENDENCY_MODE=pinned
