...
HRX_API hrx_status_t hrx_host_allocator_malloc(
...
HRX_API hrx_status_t hrx_host_allocator_realloc(
    hrx_host_allocator_t allocator, size_t byte_length, void** inout_ptr);

// Duplicates a byte block.
HRX_API hrx_status_t hrx_host_allocator_clone(
    hrx_host_allocator_t allocator, const void* src, size_t byte_length,
    void** out_ptr);

// Frees memory. NULL is a no-op.
HRX_API void hrx_host_allocator_free(hrx_host_allocator_t allocator,
                                       void* ptr);
...
HRX_API hrx_status_t hrx_allocator_allocate_buffer(
    hrx_allocator_t allocator, hrx_buffer_params_t params, size_t size,
    hrx_buffer_t* buffer);

// Import external host pointer as a hrx buffer.
HRX_API hrx_status_t hrx_allocator_import_buffer(
    hrx_allocator_t allocator, hrx_buffer_params_t params,
    void* host_ptr, size_t size, hrx_buffer_t* buffer);
...
HRX_API hrx_status_t hrx_stream_get_semaphore(
    hrx_stream_t stream, hrx_semaphore_t* semaphore);
...
HRX_API hrx_status_t hrx_stream_advance_timeline(
    hrx_stream_t stream, uint64_t* value);
...
HRX_API hrx_status_t hrx_buffer_map(hrx_buffer_t buffer,
...
HRX_API hrx_status_t hrx_buffer_get_size(hrx_buffer_t buffer,
                                            size_t* size);
...
HRX_API hrx_status_t hrx_synchronous_d2h(hrx_device_t device,
                                            hrx_buffer_t src,
...
HRX_API hrx_status_t hrx_stream_copy_buffer(
    hrx_stream_t stream, hrx_buffer_t src, size_t src_offset,
...
HRX_API hrx_status_t hrx_queue_barrier(
    hrx_device_t device, hrx_queue_affinity_t affinity,
    const hrx_semaphore_list_t* wait_semaphores,
...
HRX_API hrx_status_t hrx_queue_host_call(
    hrx_device_t device, hrx_queue_affinity_t affinity,
    const hrx_semaphore_list_t* wait_semaphores,
    const hrx_semaphore_list_t* signal_semaphores,
...
HRX_API hrx_status_t hrx_executable_load_data(
...
HRX_API hrx_status_t hrx_executable_load_file(
...
HRX_API hrx_status_t hrx_executable_export_count(
    hrx_executable_t executable, size_t* count);

HRX_API hrx_status_t hrx_executable_export_info(
    hrx_executable_t executable, uint32_t export_ordinal,
...
HRX_API hrx_status_t hrx_module_lookup_function(
...
HRX_API hrx_status_t hrx_value_list_size(hrx_value_list_t list,
                                            size_t* size);

HRX_API hrx_status_t hrx_value_list_push_i64(hrx_value_list_t list,
                                                int64_t value);

HRX_API hrx_status_t hrx_value_list_get_i64(hrx_value_list_t list,
                                               size_t index,
                                               int64_t* value);
...
HRX_API hrx_status_t hrx_fence_create(size_t capacity,
                                         hrx_fence_t* fence);
...
HRX_API hrx_status_t hrx_fence_wait(hrx_fence_t fence,
                                       uint64_t timeout_ns);
...
HRX_API hrx_status_t hrx_buffer_view_create(
