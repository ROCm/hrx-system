...
HRX_API hrx_status_t hrx_compiler_create(
...
HRX_API hrx_compiler_backend_t hrx_compiler_backend(
...
HRX_API void hrx_compiler_session_retain(
    hrx_compiler_session_t session);
HRX_API void hrx_compiler_session_release(
    hrx_compiler_session_t session);

// Replaces session-local compiler flags.
HRX_API hrx_status_t hrx_compiler_session_set_flags(
...
HRX_API void hrx_compiler_output_retain(
    hrx_compiler_output_t output);
HRX_API void hrx_compiler_output_release(
    hrx_compiler_output_t output);

// Returns borrowed VMFB bytes owned by |output|.
HRX_API const uint8_t* hrx_compiler_output_data(
    hrx_compiler_output_t output);
HRX_API size_t hrx_compiler_output_size(
    hrx_compiler_output_t output);
