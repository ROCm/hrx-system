...
#ifndef IREE_HAL_DRIVERS_HSA_NATIVE_EXECUTABLE_H_
#define IREE_HAL_DRIVERS_HSA_NATIVE_EXECUTABLE_H_
...
// implementation.
#define IREE_HAL_HSA_MAX_DISPATCH_BINDING_COUNT 16

// The max number of per-dispatch constants supported by the HSA HAL
// implementation.
#define IREE_HAL_HSA_MAX_DISPATCH_CONSTANT_COUNT 64

typedef struct iree_hal_hsa_kernel_debug_info_t {
  iree_string_view_t function_name;
  iree_string_view_t source_filename;
  uint32_t source_line;
} iree_hal_hsa_kernel_debug_info_t;
