...
hrx_status_t hrx_allocator_query_virtual_memory(
...
hrx_status_t hrx_allocator_virtual_memory_release(
...
hrx_status_t hrx_allocator_virtual_memory_map(
    hrx_allocator_t allocator, hrx_buffer_t virtual_buffer,
...
hrx_status_t hrx_allocator_virtual_memory_unmap(
    hrx_allocator_t allocator, hrx_buffer_t virtual_buffer,
