...
pyre_status_t pyre_device_can_access_peer(pyre_device_t device_a,
  ...
  // P2P access between different HAL devices is generally supported if both
  // are GPU devices on the same driver. For now, report true for GPU-GPU
  // pairs (matching streaming layer behavior where NULL topology = true).
