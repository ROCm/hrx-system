...
// Removes a public module handle from the live-handle registry and transfers
// its owning module reference to the caller. The caller must release the
// returned module or transfer ownership into another runtime object.
