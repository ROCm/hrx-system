...
// Validates |handle| by pointer identity against the live context registry and
// exclusively reserves an explicit context's public owner for destruction.
// The returned context is retained and must be released by the caller. Primary
// handles and handles already being or having been destroyed are rejected.
