...
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_MAX_FLAT_WORKGROUP_SIZE \
  (UINT64_C(1) << 8)
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_SUBGROUP_SIZE (UINT64_C(1) << 9)
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_MAX_GRID_SIZE_X (UINT64_C(1) << 10)
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_MAX_GRID_SIZE_Y (UINT64_C(1) << 11)
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_MAX_GRID_SIZE_Z (UINT64_C(1) << 12)
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_MAX_FLAT_GRID_SIZE \
  (UINT64_C(1) << 13)
...
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_PRIVATE \
  (UINT64_C(1) << 21)
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_HOST (UINT64_C(1) << 22)
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_DESCRIPTOR \
  (UINT64_C(1) << 23)
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_ABI (UINT64_C(1) << 24)
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_EXPORT_SYMBOL (UINT64_C(1) << 25)
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_LINKAGE (UINT64_C(1) << 26)
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_HAL_BUFFER_RESOURCE_FLAGS \
  (UINT64_C(1) << 27)
#define LOOM_LLVMIR_TARGET_BUILD_FLAG_HAS_CONTRACT_SET_KEY \
  (UINT64_C(1) << 28)
