...
static iree_status_t loom_pass_trace_write_jsonl(
  ...
  IREE_RETURN_IF_ERROR(loom_json_object_write_string_field(
      &object, IREE_SV("tool"), options->tool_name));
  IREE_RETURN_IF_ERROR(loom_json_object_write_string_field(
      &object, IREE_SV("input"), options->input_path));
  IREE_RETURN_IF_ERROR(loom_json_object_write_string_field(
      &object, IREE_SV("stage"), options->stage));
  IREE_RETURN_IF_ERROR(loom_json_object_write_string_field(
      &object, IREE_SV("pipeline"), event->pipeline_symbol));
  IREE_RETURN_IF_ERROR(
      loom_json_object_write_string_field(&object, IREE_SV("pass"), pass_key));
  IREE_RETURN_IF_ERROR(loom_json_object_write_string_field(
      &object, IREE_SV("pass_kind"), pass_kind));
  IREE_RETURN_IF_ERROR(loom_json_object_write_string_field(
      &object, IREE_SV("anchor"), anchor_kind));
  IREE_RETURN_IF_ERROR(loom_json_object_write_string_field(
      &object, IREE_SV("symbol"), event->symbol_name));
  IREE_RETURN_IF_ERROR(
      loom_json_object_write_string_field(&object, IREE_SV("point"), point));
  IREE_RETURN_IF_ERROR(loom_json_object_write_host_size_field(
      &object, IREE_SV("event_ordinal"), event_ordinal));
  IREE_RETURN_IF_ERROR(loom_json_object_write_host_size_field(
      &object, IREE_SV("invocation_ordinal"), event->invocation_ordinal));
  IREE_RETURN_IF_ERROR(loom_json_object_write_host_size_field(
      &object, IREE_SV("instruction_index"), event->instruction_index));
  IREE_RETURN_IF_ERROR(
  ...
  IREE_RETURN_IF_ERROR(loom_json_object_write_bool_field(
      &object, IREE_SV("changed"), event->changed));
  IREE_RETURN_IF_ERROR(
      loom_json_object_begin_field(&object, IREE_SV("diagnostics")));
  loom_json_object_writer_t diagnostics;
  IREE_RETURN_IF_ERROR(loom_json_object_begin(stream, &diagnostics));
  IREE_RETURN_IF_ERROR(loom_json_object_write_uint32_field(
      &diagnostics, IREE_SV("errors"), event->error_count));
  IREE_RETURN_IF_ERROR(loom_json_object_write_uint32_field(
      &diagnostics, IREE_SV("warnings"), event->warning_count));
  IREE_RETURN_IF_ERROR(loom_json_object_write_uint32_field(
      &diagnostics, IREE_SV("remarks"), event->remark_count));
  IREE_RETURN_IF_ERROR(loom_json_object_end(&diagnostics));
  if (artifact != NULL) {
    IREE_RETURN_IF_ERROR(loom_json_object_write_string_field(
        &object, IREE_SV("ir_path"), artifact->path));
  } else {
    IREE_RETURN_IF_ERROR(loom_json_object_begin_field(&object, IREE_SV("ir")));
