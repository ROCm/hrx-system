...
static void loom_compile_print_agents_markdown(FILE* stream) {
  fprintf(
      ...
      "estimate and is omitted when the compiler cannot prove that dynamic\n"
      "instruction mix; use `.source_low.memory` for workload-scaled source\n"
      "memory traffic when evaluating dynamic kernels.\n"
