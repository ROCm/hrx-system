...
static void loom_compile_print_agents_markdown(FILE* stream) {
  fprintf(
      ...
      "`.source_low.memory.arguments[]`; source-root and target-strategy\n"
      "attribution are under `.source_low.memory.roots[]` and\n"
      "`.source_low.memory.strategies[]` when available.\n"
