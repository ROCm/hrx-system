...
// Shared HAL candidate compile and correctness setup.

#ifndef LOOM_TOOLS_IREE_BENCHMARK_LOOM_HAL_SETUP_H_
#define LOOM_TOOLS_IREE_BENCHMARK_LOOM_HAL_SETUP_H_
...
typedef struct iree_benchmark_loom_hal_setup_options_t {
...
} iree_benchmark_loom_hal_setup_options_t;

typedef struct iree_benchmark_loom_hal_compile_context_t {
...
} iree_benchmark_loom_hal_compile_context_t;

typedef struct iree_benchmark_loom_hal_work_item_state_t {
...
// Projects single-provider compile artifacts owned by |context| into |result|.
...
// Compiles and correctness-checks one physical HAL-backed work item.
...
#endif  // LOOM_TOOLS_IREE_BENCHMARK_LOOM_HAL_SETUP_H_
