...
// one single-block body region. A variadic iter_args field, matching variadic
...
// condition region. Its entry arguments receive initial and backedge state;
// operand zero of its terminator is the condition and the remaining operands
// forward the complete state tuple to the body and results.
//
