...
// Descriptor-alias-aware allocation storage predicates. Assignment queries
// consume valid producer-owned locations; candidate/view queries establish
// whether a prospective location is legal before constructing an assignment.
