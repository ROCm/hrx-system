...
#define LOOM_NUMERIC_FORMAT_INFO_ROW(index_, format_, kind_, family_,        \
                                     storage_, exponent_, mantissa_, flags_) \
  [index_] = {                                                               \
      .format = format_,                                                     \
      .kind = kind_,                                                         \
...
static const loom_numeric_format_info_t
    kLoomNumericFormatInfos[LOOM_NUMERIC_FORMAT_INFO_COUNT] = {
        LOOM_NUMERIC_FORMAT_INFO_ROW(0, LOOM_VALUE_FACT_NUMERIC_FORMAT_F64,
                                     LOOM_NUMERIC_FORMAT_KIND_FLOAT,
                                     LOOM_NUMERIC_FLOAT_FAMILY_IEEE, 64, 11, 52,
                                     LOOM_NUMERIC_FORMAT_FLOAT_FLAGS),
        LOOM_NUMERIC_FORMAT_INFO_ROW(1, LOOM_VALUE_FACT_NUMERIC_FORMAT_F32,
                                     LOOM_NUMERIC_FORMAT_KIND_FLOAT,
                                     LOOM_NUMERIC_FLOAT_FAMILY_IEEE, 32, 8, 23,
                                     LOOM_NUMERIC_FORMAT_FLOAT_FLAGS),
        LOOM_NUMERIC_FORMAT_INFO_ROW(2, LOOM_VALUE_FACT_NUMERIC_FORMAT_TF32,
                                     LOOM_NUMERIC_FORMAT_KIND_FLOAT,
                                     LOOM_NUMERIC_FLOAT_FAMILY_IEEE, 32, 8, 10,
                                     LOOM_NUMERIC_FORMAT_FLOAT_FLAGS),
        LOOM_NUMERIC_FORMAT_INFO_ROW(3, LOOM_VALUE_FACT_NUMERIC_FORMAT_F16,
                                     LOOM_NUMERIC_FORMAT_KIND_FLOAT,
                                     LOOM_NUMERIC_FLOAT_FAMILY_IEEE, 16, 5, 10,
                                     LOOM_NUMERIC_FORMAT_FLOAT_FLAGS),
        LOOM_NUMERIC_FORMAT_INFO_ROW(4, LOOM_VALUE_FACT_NUMERIC_FORMAT_BF16,
                                     LOOM_NUMERIC_FORMAT_KIND_FLOAT,
                                     LOOM_NUMERIC_FLOAT_FAMILY_BFLOAT, 16, 8, 7,
                                     LOOM_NUMERIC_FORMAT_FLOAT_FLAGS),
        ...
        LOOM_NUMERIC_FORMAT_INFO_ROW(
            ...
            3, LOOM_NUMERIC_FORMAT_FINITE_NAN_SELECTOR_FLAGS),
        LOOM_NUMERIC_FORMAT_INFO_ROW(
        ...
        LOOM_NUMERIC_FORMAT_INFO_ROW(
            ...
            LOOM_NUMERIC_FORMAT_KIND_FLOAT, LOOM_NUMERIC_FLOAT_FAMILY_FP8, 8, 4,
            3, LOOM_NUMERIC_FORMAT_FINITE_NAN_UNSIGNED_ZERO_SELECTOR_FLAGS),
        LOOM_NUMERIC_FORMAT_INFO_ROW(
            27, LOOM_VALUE_FACT_NUMERIC_FORMAT_F8_E5M2FNUZ,
            LOOM_NUMERIC_FORMAT_KIND_FLOAT, LOOM_NUMERIC_FLOAT_FAMILY_BF8, 8, 5,
            2, LOOM_NUMERIC_FORMAT_FINITE_NAN_UNSIGNED_ZERO_SELECTOR_FLAGS),
