...
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_max_workgroup_storage_bytes, 11)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_subgroup_size, 12)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_max_grid_size_x, 13)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_max_grid_size_y, 14)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_max_grid_size_z, 15)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_max_flat_grid_size, 16)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_max_workgroup_count_x, 17)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_max_workgroup_count_y, 18)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_max_workgroup_count_z, 19)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_memory_space_generic, 20)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_memory_space_global, 21)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_memory_space_workgroup, 22)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_memory_space_constant, 23)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_memory_space_private, 24)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_memory_space_host, 25)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_memory_space_descriptor, 26)
LOOM_DEFINE_ATTR_ENUM_TYPED(loom_ireevm_target_abi, 27, loom_target_abi_kind_t)
LOOM_DEFINE_ATTR_STRING(loom_ireevm_target_export_symbol, 28)
LOOM_DEFINE_ATTR_ENUM_TYPED(loom_ireevm_target_linkage, 29, loom_target_linkage_t)
...
enum loom_ireevm_target_build_flag_bits_e {
  ...
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_STORAGE_BYTES = 1u << 9,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_SUBGROUP_SIZE = 1u << 10,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MAX_GRID_SIZE_X = 1u << 11,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MAX_GRID_SIZE_Y = 1u << 12,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MAX_GRID_SIZE_Z = 1u << 13,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MAX_FLAT_GRID_SIZE = 1u << 14,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_COUNT_X = 1u << 15,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_COUNT_Y = 1u << 16,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_COUNT_Z = 1u << 17,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_GENERIC = 1u << 18,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_GLOBAL = 1u << 19,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_WORKGROUP = 1u << 20,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_CONSTANT = 1u << 21,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_PRIVATE = 1u << 22,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_HOST = 1u << 23,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_DESCRIPTOR = 1u << 24,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_ABI = 1u << 25,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_EXPORT_SYMBOL = 1u << 26,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_LINKAGE = 1u << 27,
