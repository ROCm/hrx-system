...
// IREE VM target math legalization policy.

#ifndef LOOM_TARGET_ARCH_IREEVM_MATH_POLICY_H_
#define LOOM_TARGET_ARCH_IREEVM_MATH_POLICY_H_
...
#endif  // LOOM_TARGET_ARCH_IREEVM_MATH_POLICY_H_
