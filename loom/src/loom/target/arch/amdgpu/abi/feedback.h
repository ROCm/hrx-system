...
enum loom_amdgpu_feedback_config_layout_e {
  ...
  LOOM_AMDGPU_FEEDBACK_CONFIG_RING_BASE_OFFSET = 40u,
};
...
enum loom_amdgpu_feedback_channel_layout_e {
  ...
  LOOM_AMDGPU_FEEDBACK_CHANNEL_RING_CAPACITY_OFFSET = 16u,
  LOOM_AMDGPU_FEEDBACK_CHANNEL_READ_TAIL_OFFSET = 24u,
  LOOM_AMDGPU_FEEDBACK_CHANNEL_RESERVATION_HEAD_OFFSET = 32u,
  LOOM_AMDGPU_FEEDBACK_CHANNEL_DROPPED_PACKET_COUNT_OFFSET = 40u,
};
