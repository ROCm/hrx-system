...
typedef enum loom_amdgpu_matrix_fragment_layout_kind_e {
  ...
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_RDNA4_SWMMAC_32BIT_16X16X64_PACKED4_W64 =
      96,
  // CDNA4 MFMA 16x16x128 f8/f8 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_16X16X128_F8_F8 = 97,
  // CDNA4 MFMA 16x16x128 f8/f6 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_16X16X128_F8_F6 = 98,
  // CDNA4 MFMA 16x16x128 f8/f4 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_16X16X128_F8_F4 = 99,
  // CDNA4 MFMA 16x16x128 f6/f8 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_16X16X128_F6_F8 = 100,
  // CDNA4 MFMA 16x16x128 f6/f6 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_16X16X128_F6_F6 = 101,
  // CDNA4 MFMA 16x16x128 f6/f4 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_16X16X128_F6_F4 = 102,
  // CDNA4 MFMA 16x16x128 f4/f8 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_16X16X128_F4_F8 = 103,
  // CDNA4 MFMA 16x16x128 f4/f6 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_16X16X128_F4_F6 = 104,
  // CDNA4 MFMA 16x16x128 f4/f4 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_16X16X128_F4_F4 = 105,
  // CDNA4 MFMA 32x32x64 f8/f8 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_32X32X64_F8_F8 = 106,
  // CDNA4 MFMA 32x32x64 f8/f6 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_32X32X64_F8_F6 = 107,
  // CDNA4 MFMA 32x32x64 f8/f4 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_32X32X64_F8_F4 = 108,
  // CDNA4 MFMA 32x32x64 f6/f8 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_32X32X64_F6_F8 = 109,
  // CDNA4 MFMA 32x32x64 f6/f6 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_32X32X64_F6_F6 = 110,
  // CDNA4 MFMA 32x32x64 f6/f4 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_32X32X64_F6_F4 = 111,
  // CDNA4 MFMA 32x32x64 f4/f8 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_32X32X64_F4_F8 = 112,
  // CDNA4 MFMA 32x32x64 f4/f6 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_32X32X64_F4_F6 = 113,
  // CDNA4 MFMA 32x32x64 f4/f4 input, f32 result layout.
  LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA4_MFMA_F32_32X32X64_F4_F4 = 114,
