...
static const loom_amdgpu_matrix_fragment_layout_t kMatrixFragmentLayouts[] = {
    ...
    [LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_16X16X8_PACKED16] =
        MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32(
            LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_16X16X8_PACKED16,
            "cdna.mfma.f32.16x16x8.packed16", 8, 1, 2, 16),
    [LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_16X16X8_XF32] =
        MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32(
            LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_16X16X8_XF32,
            "cdna.mfma.f32.16x16x8.xf32", 8, 2, 1, 32),
    [LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_32X32X4_PACKED16] =
        MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_TILE(
            LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_32X32X4_PACKED16,
            "cdna.mfma.f32.32x32x4.packed16", 32, 32, 4, 16, 1, 2, 16),
    [LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_32X32X8_PACKED16] =
        MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_TILE(
            LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_32X32X8_PACKED16,
            "cdna.mfma.f32.32x32x8.packed16", 32, 32, 8, 16, 2, 2, 16),
    [LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_32X32X4_XF32] =
        MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_TILE(
            LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_32X32X4_XF32,
            "cdna.mfma.f32.32x32x4.xf32", 32, 32, 4, 16, 2, 1, 32),
    [LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_32X32X2_F32] =
        MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_TILE(
            LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_CDNA_MFMA_F32_32X32X2_F32,
            "cdna.mfma.f32.32x32x2.f32", 32, 32, 2, 16, 1, 1, 32),
    ...
    [LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_RDNA4_WMMA_F32_16X16X16_PACKED8] =
        MATRIX_FRAGMENT_LAYOUT_RDNA4_WMMA_F32(
            LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_RDNA4_WMMA_F32_16X16X16_PACKED8,
            "rdna4.wmma.f32.16x16x16.packed8", 16, 2, 4, 8),
    [LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_RDNA4_WMMA_F32_16X16X64_PACKED8] =
        MATRIX_FRAGMENT_LAYOUT_RDNA4_WMMA_F32(
            LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_RDNA4_WMMA_F32_16X16X64_PACKED8,
            "rdna4.wmma.f32.16x16x64.packed8", 64, 8, 4, 8),
    [LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_RDNA4_WMMA_F32_16X16X128_PACKED8] =
        MATRIX_FRAGMENT_LAYOUT_RDNA4_WMMA_F32(
            LOOM_AMDGPU_MATRIX_FRAGMENT_LAYOUT_RDNA4_WMMA_F32_16X16X128_PACKED8,
            "rdna4.wmma.f32.16x16x128.packed8", 128, 16, 4, 8),
};
