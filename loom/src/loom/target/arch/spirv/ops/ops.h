...
LOOM_DEFINE_ATTR_I64(loom_spirv_target_hal_buffer_resource_flags, 30)
LOOM_DEFINE_ATTR_STRING(loom_spirv_target_contract_set_key, 31)
LOOM_DEFINE_ATTR_I64(loom_spirv_target_contract_feature_bits, 32)
enum loom_spirv_target_build_flag_bits_e {
  ...
  LOOM_SPIRV_TARGET_BUILD_FLAG_HAS_HAL_BUFFER_RESOURCE_FLAGS = 1u << 28,
  LOOM_SPIRV_TARGET_BUILD_FLAG_HAS_CONTRACT_SET_KEY = 1u << 29,
  LOOM_SPIRV_TARGET_BUILD_FLAG_HAS_CONTRACT_FEATURE_BITS = 1u << 30,
};
