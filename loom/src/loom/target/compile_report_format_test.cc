...
TEST(CompileReportFormatTest, FormatsSummaryAndDetails) {
  ...
  EXPECT_NE(iree_string_view_find(
                ...
                IREE_SV("target_resources scalar_register_class=amdgpu.sgpr "
                        "scalar_final_registers=38 "
                        "scalar_scheduled_pressure_peak=32 "
                        "scalar_final_overhead=6 "
                        "vector_register_class=amdgpu.vgpr "
                        "vector_final_registers=112 "
                        "vector_scheduled_pressure_peak=96 "
                        "vector_final_overhead=16 subgroup_size=32 "
                        "resident_subgroups_per_simd=8 "
                        "max_subgroups_per_simd=16 "
  ...
  EXPECT_NE(iree_string_view_find(
                output,
                IREE_SV("\"target_resources\":{\"scalar\":{\"register_class\":"
                        "\"amdgpu.sgpr\",\"final\":{\"register_count\":38,"
                        "\"overhead_units\":6},\"scheduled_pressure\":{"
                        "\"peak_live_units\":32}},\"vector\":{"
                        "\"register_class\":\"amdgpu.vgpr\",\"final\":{"
                        "\"register_count\":112,\"overhead_units\":16},"
                        "\"scheduled_pressure\":{\"peak_live_units\":96}},"
                        "\"subgroup_size\":32,"
                        "\"max_subgroups_per_simd\":16,"
                        "\"resident_subgroups_per_simd\":8,"
