...
#ifndef LOOM_TARGET_REPORTING_FORMAT_JSON_LOWERING_H_
#define LOOM_TARGET_REPORTING_FORMAT_JSON_LOWERING_H_
...
#endif  // LOOM_TARGET_REPORTING_FORMAT_JSON_LOWERING_H_
