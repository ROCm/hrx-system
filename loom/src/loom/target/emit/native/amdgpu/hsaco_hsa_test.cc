...
iree_status_t FormatTargetRecordForProfile(
  ...
  *out_target_record = {};
  ...
  if (is_gfx1250) {
    ...
    target_record +=
        profile->amdhsa.gfx1250_revision == LOOM_AMDGPU_GFX1250_REVISION_A0
            ? "a0"
            : "b0";
    target_record += "}";
  }
...
iree_status_t PrepareTargetProfileForLowHsaco(
  ...
  *out_target_profile = {};
  ...
  return loom_amdgpu_target_profile_initialize(&amdhsa, out_target_profile);
}
...
iree_status_t EmitB128CopyKernelForAmdgpu(const AmdgpuHsaTarget& target,
  ...
  *out_hsaco = {};
  ...
  const loom_amdgpu_processor_info_t* processor =
      target_profile.amdhsa.processor;
...
iree_status_t EmitRuntimeGlobalKernelForAmdgpu(const AmdgpuHsaTarget& target,
  ...
  *out_hsaco = {};
  ...
  revisioned_kernel.metadata.gfx1250_revision =
      target_profile.amdhsa.gfx1250_revision;
