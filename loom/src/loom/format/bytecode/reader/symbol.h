...
// Symbol-table validation and full IR materialization.

#ifndef LOOM_FORMAT_BYTECODE_READER_SYMBOL_H_
#define LOOM_FORMAT_BYTECODE_READER_SYMBOL_H_
...
#endif  // LOOM_FORMAT_BYTECODE_READER_SYMBOL_H_
