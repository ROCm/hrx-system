...
def _emit_encode_pair(row: Fp8Format, source_format: _BinaryFormat) -> str:
    ...
    lines = [
        ...
        *_emit_exact_vector(
        ...
        f"  vector.store %difference_head, %output_view[%head_offset] : vector<8xi8>, view<{exact_width}xi8, #encoding.layout.dense>",
        *_emit_exact_vector(
            tail,
            source_format.integer_type_spelling,
            source_format.bit_count,
        ...
        f"  vector.store %difference_tail, %output_view[%tail_offset] : vector<{len(tail)}xi8>, view<{exact_width}xi8, #encoding.layout.dense>",
        "  kernel.return",
        "}",
        "",
        ...
        "    vector.store %encoded_bits, %output_view[%row, %column] : vector<8xi8>, view<[%bounded_row_count]x8xi8, #encoding.layout.dense>",
        "  }",
        "  kernel.return",
        "}",
        "",
...
def _emit_decode_pair(row: Fp8Format, result_format: _BinaryFormat) -> str:
    ...
    lines = [
        ...
        *_emit_exact_vector(
        ...
        f"  vector.store %difference_head, %output_view[%head_offset] : vector<8x{output_integer_type}>, view<{exact_width}x{output_integer_type}, #encoding.layout.dense>",
        *_emit_exact_vector(
            tail,
            "i8",
            8,
        ...
        f"  vector.store %difference_tail, %output_view[%tail_offset] : vector<{len(tail)}x{output_integer_type}>, view<{exact_width}x{output_integer_type}, #encoding.layout.dense>",
        "  kernel.return",
        "}",
        "",
        f"kernel.def @{row_kernel_name}(%row_count: index) {{",
        ...
        f"    vector.store %decoded, %output_view[%row, %column] : vector<8x{result_name}>, view<[%bounded_row_count]x8x{result_name}, #encoding.layout.dense>",
        "  }",
        "  kernel.return",
        "}",
        "",
