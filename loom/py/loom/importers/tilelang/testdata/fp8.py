...
kernel.def target(@hip_mcpu_gfx942) export("fp8_fn_buffer_views") @fp8_fn_buffer_views() {
  ...
  %fp8_e4m3fn_schema = encoding.define #fp8_e4m3fn : encoding<schema>
  %src_storage = encoding.define #physical_storage {layout = %layout : encoding<layout>, schema = %fp8_e4m3fn_schema : encoding<schema>} : encoding<storage>
