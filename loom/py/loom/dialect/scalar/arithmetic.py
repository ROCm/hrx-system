...
scalar_minnumf = binary_op(
    ...
    phase=OpPhase.EXECUTABLE,
    type_constraint=FLOAT,
    doc=("Number-selecting minimum. One NaN selects the numeric operand, two NaNs produce NaN, and opposite signed zeros select -0."),
    commutative=True,
    flags=("fastmath", FastMathFlags),
...
scalar_maxnumf = binary_op(
    ...
    phase=OpPhase.EXECUTABLE,
    type_constraint=FLOAT,
    doc=("Number-selecting maximum. One NaN selects the numeric operand, two NaNs produce NaN, and opposite signed zeros select +0."),
    commutative=True,
    flags=("fastmath", FastMathFlags),
