...
FEATURE_ATOMS = (
    ...
    FeatureAtom(
        key="vulkan_memory_model_device_scope",
        c_suffix="VULKAN_MEMORY_MODEL_DEVICE_SCOPE",
        name="spirv.vulkan.memory_model.device_scope",
        doc="Vulkan memory-model Device scope support.",
        required=("vulkan_shader",),
        minimum_spirv_version=SPIRV_VERSION_1_3,
        capabilities=("LOOM_SPIRV_CAPABILITY_VULKAN_MEMORY_MODEL_DEVICE_SCOPE",),
    ),
    FeatureAtom(
        key="storage_buffer_int64_atomics",
        c_suffix="STORAGE_BUFFER_INT64_ATOMICS",
        name="spirv.atomic.storage_buffer.int64",
        doc="64-bit integer atomics in storage-buffer memory.",
        required=("vulkan_shader", "int64"),
        minimum_spirv_version=SPIRV_VERSION_1_0,
        capabilities=("LOOM_SPIRV_CAPABILITY_INT64_ATOMICS",),
    ),
    FeatureAtom(
        key="workgroup_int64_atomics",
        c_suffix="WORKGROUP_INT64_ATOMICS",
        name="spirv.atomic.workgroup.int64",
        doc="64-bit integer atomics in workgroup memory.",
        required=("vulkan_shader", "int64"),
        minimum_spirv_version=SPIRV_VERSION_1_0,
        capabilities=("LOOM_SPIRV_CAPABILITY_INT64_ATOMICS",),
    ),
    FeatureAtom(
        key="storage_buffer_float16_atomics",
        c_suffix="STORAGE_BUFFER_FLOAT16_ATOMICS",
        name="spirv.atomic.storage_buffer.float16",
        doc="16-bit floating-point basic atomics in storage-buffer memory.",
        required=("vulkan_shader", "float16"),
        minimum_spirv_version=SPIRV_VERSION_1_0,
    ),
    FeatureAtom(
        key="workgroup_float16_atomics",
        c_suffix="WORKGROUP_FLOAT16_ATOMICS",
        name="spirv.atomic.workgroup.float16",
        doc="16-bit floating-point basic atomics in workgroup memory.",
        required=("vulkan_shader", "float16"),
        minimum_spirv_version=SPIRV_VERSION_1_0,
    ),
    FeatureAtom(
        key="storage_buffer_float16_atomic_add",
        c_suffix="STORAGE_BUFFER_FLOAT16_ATOMIC_ADD",
        name="spirv.atomic.storage_buffer.float16.add",
        doc="16-bit floating-point atomic add in storage-buffer memory.",
        required=("vulkan_shader", "float16"),
        minimum_spirv_version=SPIRV_VERSION_1_0,
        extensions=(
        ...
        capabilities=("LOOM_SPIRV_CAPABILITY_ATOMIC_FLOAT16_ADD_EXT",),
        opcodes=("LOOM_SPIRV_OP_ATOMIC_F_ADD_EXT",),
    ),
    FeatureAtom(
        key="workgroup_float16_atomic_add",
        c_suffix="WORKGROUP_FLOAT16_ATOMIC_ADD",
        name="spirv.atomic.workgroup.float16.add",
        doc="16-bit floating-point atomic add in workgroup memory.",
        required=("vulkan_shader", "float16"),
        minimum_spirv_version=SPIRV_VERSION_1_0,
        extensions=(
            "SPV_EXT_shader_atomic_float_add",
    ...
    FeatureAtom(
        key="storage_buffer_float32_atomics",
        c_suffix="STORAGE_BUFFER_FLOAT32_ATOMICS",
        name="spirv.atomic.storage_buffer.float32",
        doc="32-bit floating-point basic atomics in storage-buffer memory.",
        required=("vulkan_shader",),
        minimum_spirv_version=SPIRV_VERSION_1_0,
    ),
    FeatureAtom(
        key="workgroup_float32_atomics",
        c_suffix="WORKGROUP_FLOAT32_ATOMICS",
        name="spirv.atomic.workgroup.float32",
        doc="32-bit floating-point basic atomics in workgroup memory.",
        required=("vulkan_shader",),
        minimum_spirv_version=SPIRV_VERSION_1_0,
    ),
    FeatureAtom(
        key="storage_buffer_float32_atomic_add",
        c_suffix="STORAGE_BUFFER_FLOAT32_ATOMIC_ADD",
        name="spirv.atomic.storage_buffer.float32.add",
        doc="32-bit floating-point atomic add in storage-buffer memory.",
        required=("vulkan_shader",),
        minimum_spirv_version=SPIRV_VERSION_1_0,
        extensions=("SPV_EXT_shader_atomic_float_add",),
        capabilities=("LOOM_SPIRV_CAPABILITY_ATOMIC_FLOAT32_ADD_EXT",),
        opcodes=("LOOM_SPIRV_OP_ATOMIC_F_ADD_EXT",),
    ),
    FeatureAtom(
        key="workgroup_float32_atomic_add",
        c_suffix="WORKGROUP_FLOAT32_ATOMIC_ADD",
        name="spirv.atomic.workgroup.float32.add",
        doc="32-bit floating-point atomic add in workgroup memory.",
        required=("vulkan_shader",),
        minimum_spirv_version=SPIRV_VERSION_1_0,
        extensions=("SPV_EXT_shader_atomic_float_add",),
        capabilities=("LOOM_SPIRV_CAPABILITY_ATOMIC_FLOAT32_ADD_EXT",),
    ...
    FeatureAtom(
        key="storage_buffer_float64_atomics",
        c_suffix="STORAGE_BUFFER_FLOAT64_ATOMICS",
        name="spirv.atomic.storage_buffer.float64",
        doc="64-bit floating-point basic atomics in storage-buffer memory.",
        required=("vulkan_shader", "float64"),
        minimum_spirv_version=SPIRV_VERSION_1_0,
    ),
    FeatureAtom(
        key="workgroup_float64_atomics",
        c_suffix="WORKGROUP_FLOAT64_ATOMICS",
        name="spirv.atomic.workgroup.float64",
        doc="64-bit floating-point basic atomics in workgroup memory.",
        required=("vulkan_shader", "float64"),
        minimum_spirv_version=SPIRV_VERSION_1_0,
    ),
    FeatureAtom(
        key="storage_buffer_float64_atomic_add",
        c_suffix="STORAGE_BUFFER_FLOAT64_ATOMIC_ADD",
        name="spirv.atomic.storage_buffer.float64.add",
        doc="64-bit floating-point atomic add in storage-buffer memory.",
        required=("vulkan_shader", "float64"),
        minimum_spirv_version=SPIRV_VERSION_1_0,
        extensions=("SPV_EXT_shader_atomic_float_add",),
        capabilities=("LOOM_SPIRV_CAPABILITY_ATOMIC_FLOAT64_ADD_EXT",),
        opcodes=("LOOM_SPIRV_OP_ATOMIC_F_ADD_EXT",),
    ),
    FeatureAtom(
        key="workgroup_float64_atomic_add",
        c_suffix="WORKGROUP_FLOAT64_ATOMIC_ADD",
        name="spirv.atomic.workgroup.float64.add",
        doc="64-bit floating-point atomic add in workgroup memory.",
        required=("vulkan_shader", "float64"),
        minimum_spirv_version=SPIRV_VERSION_1_0,
        extensions=("SPV_EXT_shader_atomic_float_add",),
        capabilities=("LOOM_SPIRV_CAPABILITY_ATOMIC_FLOAT64_ADD_EXT",),
    ...
    FeatureAtom(
        key="group_non_uniform",
        c_suffix="GROUP_NON_UNIFORM",
        name="spirv.group_non_uniform",
        doc="Core subgroup operations and subgroup memory scope.",
        required=("vulkan_shader",),
        minimum_spirv_version=SPIRV_VERSION_1_3,
