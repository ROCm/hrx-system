...
option(IREE_NET_TRANSPORT_DEFAULTS
  "Default value for opt-in runtime network transports." OFF)
if(NOT DEFINED IREE_NET_TRANSPORT_TCP_DEFAULT)
  set(IREE_NET_TRANSPORT_TCP_DEFAULT ON)
endif()
...
if(NOT DEFINED IREE_HAL_DRIVER_REMOTE_DEFAULT)
  set(IREE_HAL_DRIVER_REMOTE_DEFAULT ON)
endif()
...
option(IREE_HAL_DRIVER_REMOTE
  "Enables the remote runtime HAL driver."
  ${IREE_HAL_DRIVER_REMOTE_DEFAULT})
