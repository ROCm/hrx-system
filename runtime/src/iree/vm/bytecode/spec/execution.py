...
EXECUTABLE_INSTRUCTIONS = (
    ...
    ExecutableInstruction("integer.div.s32", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.div.s64", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.div.u32", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.div.u64", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.rem.s32", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.rem.s64", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.rem.u32", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.rem.u64", "VALUE_BINARY_4"),
    ...
    ExecutableInstruction("integer.shift.left.i32", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.shift.left.i64", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.shift.right.s32", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.shift.right.s64", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.shift.right.u32", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.shift.right.u64", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.rotate.left.i32", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.rotate.left.i64", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.rotate.right.i32", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.rotate.right.i64", "VALUE_BINARY_4"),
    ExecutableInstruction("integer.count.leading.zeros.i32", "VALUE_UNARY_4"),
    ExecutableInstruction("integer.count.leading.zeros.i64", "VALUE_UNARY_4"),
    ExecutableInstruction("integer.count.trailing.zeros.i32", "VALUE_UNARY_4"),
    ExecutableInstruction("integer.count.trailing.zeros.i64", "VALUE_UNARY_4"),
    ExecutableInstruction("integer.popcount.i32", "VALUE_UNARY_4"),
    ExecutableInstruction("integer.popcount.i64", "VALUE_UNARY_4"),
    ...
    ExecutableInstruction("integer.bitstream.pack", "INTEGER_BITSTREAM_PACK"),
    ExecutableInstruction("integer.bitstream.unpack.u", "INTEGER_BITSTREAM_UNPACK"),
    ExecutableInstruction("integer.bitstream.unpack.s", "INTEGER_BITSTREAM_UNPACK"),
    ...
    ExecutableInstruction("buffer.allocate", "BUFFER_ALLOCATE"),
    ExecutableInstruction("buffer.length", "BUFFER_LENGTH"),
    ExecutableInstruction("buffer.subspan", "BUFFER_SUBSPAN"),
    ExecutableInstruction("buffer.load", "BUFFER_LOAD"),
    ExecutableInstruction("buffer.store", "BUFFER_STORE"),
    ExecutableInstruction("buffer.atomic.reduce", "BUFFER_ATOMIC_REDUCE"),
    ExecutableInstruction("buffer.atomic.rmw", "BUFFER_ATOMIC_RMW"),
    ExecutableInstruction("buffer.atomic.cmpxchg", "BUFFER_ATOMIC_CMPXCHG"),
    ExecutableInstruction("buffer.fill", "BUFFER_FILL"),
    ExecutableInstruction("buffer.copy", "BUFFER_COPY"),
    ExecutableInstruction("buffer.compare", "BUFFER_COMPARE"),
    ExecutableInstruction("buffer.copy.rodata", "BUFFER_COPY_RODATA"),
    ...
    ExecutableInstruction("conversion.float.truncate", "CONVERSION_FLOAT_TRUNCATE"),
    ExecutableInstruction("conversion.float.width", "CONVERSION_FLOAT_WIDTH"),
    ExecutableInstruction("conversion.integer.to.float", "CONVERSION_INTEGER_TO_FLOAT"),
    ...
    ExecutableInstruction("stack.copy.from.buffer", "STACK_COPY_FROM_BUFFER"),
    ExecutableInstruction("stack.copy.to.buffer", "STACK_COPY_TO_BUFFER"),
