...
SECTIONS = (
    ...
    Section(
        ...
        normative_text=(
            ...
            "Each row owns one field row for every machine argument in source "
            "order followed by every machine result in source order of its "
            "declaration's callable signature. When ABI lowering expands one "
            "authored aggregate into multiple machine fields, its optional name "
            "and authored field type anchor on the first field and continuation "
            "fields use canonical null strings. field_base is the checked "
            "running prefix and the final field end consumes the section. Every "
            "string field uses "
...
VALIDATION_OBLIGATIONS = (
    ...
    ValidationObligation(
        ...
        normative_text=(
            ...
            "Require one field row for every machine argument in source order "
            "followed by every machine result in source order, require field_base "
            "to equal the "
