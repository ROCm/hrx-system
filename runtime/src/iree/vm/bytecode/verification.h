...
enum iree_vm_bytecode_verification_rule_kind_e {
  ...
  IREE_VM_BYTECODE_VERIFICATION_RULE_ABI_SLOT = 34,
  ...
  IREE_VM_BYTECODE_VERIFICATION_RULE_LOCAL_BYTES_RANGE_BASE = 41,
  IREE_VM_BYTECODE_VERIFICATION_RULE_LOCAL_BYTES_FIXED_BASE = 42,
  IREE_VM_BYTECODE_VERIFICATION_RULE_LOCAL_BYTES_RANGE_MEMORY_FORMAT = 43,
  IREE_VM_BYTECODE_VERIFICATION_RULE_RODATA_ORDINAL = 44,
