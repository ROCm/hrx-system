...
#define IREE_VM_BYTECODE_ATOMIC_I32_SUPPORTED 1
#define IREE_VM_BYTECODE_ATOMIC_I64_SUPPORTED 1
...
#define IREE_VM_BYTECODE_ATOMIC_I64_SUPPORTED 1
#else
#define IREE_VM_BYTECODE_ATOMIC_I64_SUPPORTED 0
#endif  // __GCC_ATOMIC_LLONG_LOCK_FREE
#else
#define IREE_VM_BYTECODE_ATOMIC_I32_SUPPORTED 0
#define IREE_VM_BYTECODE_ATOMIC_I64_SUPPORTED 0
#endif  // atomic carrier support
...
#if !IREE_SYNCHRONIZATION_DISABLE_UNSAFE &&   \
    !defined(IREE_COMPILER_MSVC_COMPAT) &&    \
    (IREE_VM_BYTECODE_ATOMIC_I32_SUPPORTED || \
     IREE_VM_BYTECODE_ATOMIC_I64_SUPPORTED)
...
bool iree_vm_bytecode_atomic_carrier_is_supported(
  ...
  switch (carrier) {
    case IREE_VM_ISA_BUFFER_ATOMIC_CARRIER_I32:
      return IREE_VM_BYTECODE_ATOMIC_I32_SUPPORTED;
    case IREE_VM_ISA_BUFFER_ATOMIC_CARRIER_I64:
      return IREE_VM_BYTECODE_ATOMIC_I64_SUPPORTED;
    default:
      return false;
  }
}

#if IREE_VM_BYTECODE_ATOMIC_I32_SUPPORTED
...
#endif  // IREE_VM_BYTECODE_ATOMIC_I32_SUPPORTED

#if IREE_VM_BYTECODE_ATOMIC_I64_SUPPORTED
...
#endif  // IREE_VM_BYTECODE_ATOMIC_I64_SUPPORTED
...
static uint32_t iree_vm_bytecode_atomic_apply_kind_u32(
  ...
  switch (kind) {
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_EXCHANGE_INTEGER:
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_EXCHANGE_FLOAT:
      return operand_bits;
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_ADD_INTEGER:
      return old_bits + operand_bits;
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_ADD_FLOAT:
    ...
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_SUBTRACT_INTEGER:
      return old_bits - operand_bits;
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_AND_INTEGER:
      return old_bits & operand_bits;
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_OR_INTEGER:
      return old_bits | operand_bits;
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_XOR_INTEGER:
      return old_bits ^ operand_bits;
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_MINIMUM_SIGNED:
      return (old_bits ^ UINT32_C(0x80000000)) <
                     (operand_bits ^ UINT32_C(0x80000000))
                 ? old_bits
                 : operand_bits;
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_MAXIMUM_SIGNED:
      return (old_bits ^ UINT32_C(0x80000000)) >
                     (operand_bits ^ UINT32_C(0x80000000))
                 ? old_bits
                 : operand_bits;
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_MINIMUM_UNSIGNED:
      return iree_min(old_bits, operand_bits);
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_MAXIMUM_UNSIGNED:
      return iree_max(old_bits, operand_bits);
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_MINIMUM_FLOAT:
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_MAXIMUM_FLOAT:
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_MINNUM_FLOAT:
    case IREE_VM_ISA_BUFFER_ATOMIC_KIND_MAXNUM_FLOAT:
      return iree_vm_bytecode_float_minmax_f32_bits(
          old_bits, operand_bits,
          kind - IREE_VM_ISA_BUFFER_ATOMIC_KIND_MINIMUM_FLOAT);
    default:
...
uint64_t iree_vm_bytecode_atomic_apply(
  ...
  (void)kind;
  (void)ordering;
#endif  // no supported atomic carriers
  switch (carrier) {
#if IREE_VM_BYTECODE_ATOMIC_I32_SUPPORTED
    case IREE_VM_ISA_BUFFER_ATOMIC_CARRIER_I32: {
      ...
      while (!iree_vm_bytecode_atomic_compare_exchange_u32(
          ...
          ordering, IREE_VM_ISA_BUFFER_ATOMIC_ORDERING_RELAXED)) {
      }
...
#endif  // IREE_VM_BYTECODE_ATOMIC_I64_SUPPORTED
    default:
      IREE_ASSERT_UNREACHABLE("atomic carrier must be verified as supported");
      return 0;
  }
}
