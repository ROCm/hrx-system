...
#include "iree/vm/bytecode/disassembler/data.inl"
#include "iree/vm/bytecode/wire/module.h"

static iree_string_view_t iree_vm_bytecode_disassembler_string_at(
    uint16_t offset) {
...
iree_vm_bytecode_disassembler_instruction_name(uint8_t opcode) {
  return iree_vm_bytecode_disassembler_string_at(
