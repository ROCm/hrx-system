...
void CheckEverySelector() {
  ...
  for (uint8_t selector = IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXP;
       selector <= IREE_VM_BYTECODE_FLOAT_MATH_UNARY_GELU_TANH; ++selector) {
  ...
  ExpectBits(EvaluateBinary<Float>(IREE_VM_BYTECODE_FLOAT_MATH_BINARY_POW,
                                   Float{0.5}, Float{3}),
             std::pow(Float{0.5}, Float{3}));
  ExpectBits(EvaluateBinary<Float>(IREE_VM_BYTECODE_FLOAT_MATH_BINARY_ATAN2,
                                   Float{0.5}, Float{3}),
  ...
  ExpectBits(
      EvaluateBinary<Float>(IREE_VM_BYTECODE_FLOAT_MATH_BINARY_GELU_LOGISTIC,
                            kInput, Float{1.702}),
      gelu_logistic);
  ExpectBits(EvaluateTernary<Float>(IREE_VM_BYTECODE_FLOAT_MATH_TERNARY_FMA,
...
void CheckExceptionalValues() {
  ...
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXP, -infinity, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXP, infinity, infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXP, zero, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXP, negative_zero, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXP2, -infinity, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXP2, infinity, infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXP2, zero, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXP2, negative_zero, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXPM1, -infinity, Float{-1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXPM1, infinity, infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXPM1, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXPM1, negative_zero, negative_zero);

  for (uint8_t selector : {IREE_VM_BYTECODE_FLOAT_MATH_UNARY_LOG,
                           IREE_VM_BYTECODE_FLOAT_MATH_UNARY_LOG2,
                           IREE_VM_BYTECODE_FLOAT_MATH_UNARY_LOG10}) {
  ...
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_LOG1P, Float{-1}, -infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_LOG1P, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_LOG1P, negative_zero, negative_zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_LOG1P, infinity, infinity);
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_LOG1P, Float{-2});

  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SQRT, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SQRT, negative_zero, negative_zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SQRT, infinity, infinity);
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SQRT, Float{-1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_RSQRT, zero, infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_RSQRT, negative_zero, -infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_RSQRT, infinity, zero);
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_RSQRT, Float{-1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_CBRT, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_CBRT, negative_zero, negative_zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_CBRT, infinity, infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_CBRT, -infinity, -infinity);

  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SIN, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SIN, negative_zero, negative_zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COS, zero, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COS, negative_zero, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_TAN, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_TAN, negative_zero, negative_zero);
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SIN, infinity);
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COS, infinity);
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_TAN, infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ASIN, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ASIN, negative_zero, negative_zero);
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ASIN, Float{2});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ACOS, Float{1}, zero);
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ACOS, Float{2});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ATAN, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ATAN, negative_zero, negative_zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ATAN, infinity, std::atan(infinity));
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ATAN, -infinity,
        std::atan(-infinity));

  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SINH, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SINH, negative_zero, negative_zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SINH, infinity, infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SINH, -infinity, -infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COSH, zero, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COSH, negative_zero, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COSH, infinity, infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COSH, -infinity, infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_TANH, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_TANH, negative_zero, negative_zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_TANH, infinity, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_TANH, -infinity, Float{-1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ASINH, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ASINH, negative_zero, negative_zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ASINH, infinity, infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ASINH, -infinity, -infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ACOSH, Float{1}, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ACOSH, infinity, infinity);
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ACOSH, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ATANH, negative_zero, negative_zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ATANH, Float{-1}, -infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ATANH, Float{1}, infinity);
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ATANH, Float{2});

  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ERF, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ERF, negative_zero, negative_zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ERF, infinity, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ERF, -infinity, Float{-1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ERFC, -infinity, Float{2});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ERFC, infinity, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_LOGISTIC, -infinity, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_LOGISTIC, zero, Float{0.5});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_LOGISTIC, negative_zero, Float{0.5});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_LOGISTIC, infinity, Float{1});
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SILU, -infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SILU, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SILU, negative_zero, negative_zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SILU, infinity, infinity);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SOFTPLUS, -infinity, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SOFTPLUS, zero, std::log1p(Float{1}));
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SOFTPLUS, negative_zero,
        std::log1p(Float{1}));
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SOFTPLUS, infinity, infinity);

  for (uint8_t selector : {IREE_VM_BYTECODE_FLOAT_MATH_UNARY_CEIL,
                           IREE_VM_BYTECODE_FLOAT_MATH_UNARY_FLOOR,
                           IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ROUND,
                           IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ROUNDEVEN,
                           IREE_VM_BYTECODE_FLOAT_MATH_UNARY_TRUNC}) {
    exact(selector, zero, zero);
    exact(selector, negative_zero, negative_zero);
    exact(selector, infinity, infinity);
    exact(selector, -infinity, -infinity);
  }
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ROUND, Float{2.5}, Float{3});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ROUND, Float{-2.5}, Float{-3});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ROUNDEVEN, Float{2.5}, Float{2});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_ROUNDEVEN, Float{3.5}, Float{4});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SIGN, quiet_nan, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SIGN, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SIGN, negative_zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SIGN, Float{-2}, Float{-1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SIGN, infinity, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SIGN, -infinity, Float{-1});

  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SINTURNS, zero, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SINTURNS, negative_zero,
        negative_zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COSTURNS, zero, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COSTURNS, negative_zero, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SINTURNS, Float{0.25}, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SINTURNS, Float{0.5}, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SINTURNS, Float{-0.5}, negative_zero);
  const Float large_turn =
      std::ldexp(Float{1}, std::numeric_limits<Float>::digits);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SINTURNS, large_turn, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COSTURNS, large_turn, Float{1});
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COSTURNS, Float{0.25}, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COSTURNS, Float{-0.25}, zero);
  exact(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COSTURNS, Float{0.5}, Float{-1});
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SINTURNS, infinity);
  arithmetic_nan(IREE_VM_BYTECODE_FLOAT_MATH_UNARY_COSTURNS, -infinity);

  for (uint8_t selector : {IREE_VM_BYTECODE_FLOAT_MATH_UNARY_GELU_ERF,
                           IREE_VM_BYTECODE_FLOAT_MATH_UNARY_GELU_TANH}) {
  ...
  for (Float nan : {quiet_nan, signaling_nan}) {
    for (uint8_t selector = IREE_VM_BYTECODE_FLOAT_MATH_UNARY_EXP;
         selector <= IREE_VM_BYTECODE_FLOAT_MATH_UNARY_GELU_TANH; ++selector) {
      if (selector == IREE_VM_BYTECODE_FLOAT_MATH_UNARY_SIGN) {
  ...
  ExpectArithmeticNaN(EvaluateBinary<Float>(
      IREE_VM_BYTECODE_FLOAT_MATH_BINARY_POW, Float{-2}, Float{0.5}));
  ExpectArithmeticNaN(EvaluateBinary<Float>(
      IREE_VM_BYTECODE_FLOAT_MATH_BINARY_POW, signaling_nan, Float{1}));
  ExpectBits(EvaluateBinary<Float>(IREE_VM_BYTECODE_FLOAT_MATH_BINARY_ATAN2,
  ...
  ExpectArithmeticNaN(EvaluateBinary<Float>(
      IREE_VM_BYTECODE_FLOAT_MATH_BINARY_ATAN2, signaling_nan, Float{1}));
  ...
  ExpectArithmeticNaN(
      EvaluateBinary<Float>(IREE_VM_BYTECODE_FLOAT_MATH_BINARY_GELU_LOGISTIC,
                            Float{1}, signaling_nan));

  ExpectArithmeticNaN(EvaluateTernary<Float>(
      IREE_VM_BYTECODE_FLOAT_MATH_TERNARY_FMA, infinity, zero, Float{1}));
  ExpectBits(EvaluateTernary<Float>(IREE_VM_BYTECODE_FLOAT_MATH_TERNARY_FMA,
  ...
  ExpectBits(EvaluateTernary<Float>(IREE_VM_BYTECODE_FLOAT_MATH_TERNARY_FMA,
             ...
             infinity);
  ExpectArithmeticNaN(EvaluateTernary<Float>(
      IREE_VM_BYTECODE_FLOAT_MATH_TERNARY_FMA, infinity, Float{1}, -infinity));
  ExpectArithmeticNaN(
      EvaluateTernary<Float>(IREE_VM_BYTECODE_FLOAT_MATH_TERNARY_FMA,
                             signaling_nan, Float{1}, Float{1}));
}
...
void CheckFusedRounding() {
  ...
  const Float fused =
      EvaluateTernary<Float>(IREE_VM_BYTECODE_FLOAT_MATH_TERNARY_FMA, a, b, c);
