...
static const char kIreeProfileUsage[] =
    ...
    "\n"
    "Capture examples:\n"
    "  iree-benchmark-replay --device=amdgpu --benchmark_min_time=20x \\\n"
...
static void iree_profile_print_agent_markdown_capture(FILE* file) {
  fputs(
      ...
      "## Capture\n"
      "\n"
      "Capture from `iree-benchmark-replay` with HAL queue profiling "
      "enabled:\n"
      "\n"
      "```bash\n"
      "iree-benchmark-replay --device=amdgpu --benchmark_min_time=20x \\\n"
...
static void iree_profile_print_agent_markdown_jsonl_contracts(FILE* file) {
  fputs(
      ...
      "is a\n"
      "`schema` record describing time domains, elapsed-duration scaling, "
      "and\n"
      "absolute clock-fit behavior. Device timestamp metadata can scale "
      "elapsed\n"
      "ticks even when no correlation can place those ticks on a host "
      "timeline.\n"
      "Use this\n"
...
static void iree_profile_print_agent_markdown_recipes(FILE* file) {
  fputs(
      ...
      "duration_scale_source,derived_time_available,derived_time_domain}' "
      "\\\n"
