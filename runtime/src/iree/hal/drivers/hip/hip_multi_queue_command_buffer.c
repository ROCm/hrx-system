...
static iree_status_t iree_hal_hip_multi_queue_command_buffer_atomic_wait(
    iree_hal_command_buffer_t* base_command_buffer,
    iree_hal_execution_stage_t source_stage_mask,
    iree_hal_execution_stage_t target_stage_mask,
  ...
  return iree_make_status(
      ...
      "HIP multi-queue command buffers do not support atomic waits");
}

static iree_status_t iree_hal_hip_multi_queue_command_buffer_atomic_store(
    iree_hal_command_buffer_t* base_command_buffer,
    iree_hal_execution_stage_t source_stage_mask,
    iree_hal_execution_stage_t target_stage_mask,
  ...
  return iree_make_status(
      IREE_STATUS_UNIMPLEMENTED,
      "HIP multi-queue command buffers do not support atomic stores");
}

static iree_status_t iree_hal_hip_multi_queue_command_buffer_atomic_rmw(
    iree_hal_command_buffer_t* base_command_buffer,
    iree_hal_execution_stage_t source_stage_mask,
    iree_hal_execution_stage_t target_stage_mask,
  ...
  return iree_make_status(
      IREE_STATUS_UNIMPLEMENTED,
      "HIP multi-queue command buffers do not support atomic "
      "read-modify-write");
}
