...
static iree_status_t iree_hal_metal_command_buffer_atomic_wait(
    iree_hal_command_buffer_t* base_command_buffer, iree_hal_execution_stage_t source_stage_mask,
    iree_hal_execution_stage_t target_stage_mask, iree_hal_buffer_ref_t target_ref,
    iree_hal_atomic_wait_params_t params) {
  return iree_make_status(IREE_STATUS_UNIMPLEMENTED,
                          "Metal command buffers do not support atomic waits");
}

static iree_status_t iree_hal_metal_command_buffer_atomic_store(
    iree_hal_command_buffer_t* base_command_buffer, iree_hal_execution_stage_t source_stage_mask,
    iree_hal_execution_stage_t target_stage_mask, iree_hal_buffer_ref_t target_ref,
    iree_hal_atomic_store_params_t params) {
  return iree_make_status(IREE_STATUS_UNIMPLEMENTED,
                          "Metal command buffers do not support atomic stores");
}

static iree_status_t iree_hal_metal_command_buffer_atomic_rmw(
    iree_hal_command_buffer_t* base_command_buffer, iree_hal_execution_stage_t source_stage_mask,
    iree_hal_execution_stage_t target_stage_mask, iree_hal_buffer_ref_t target_ref,
