...
static iree_status_t iree_hal_null_executable_global_count(
    iree_hal_executable_t* base_executable, iree_host_size_t* out_count) {
  (void)base_executable;
  *out_count = 0;
  return iree_make_status(IREE_STATUS_UNIMPLEMENTED,
                          "null executable globals are not enumerable");
}

static iree_status_t iree_hal_null_executable_global_info_by_index(
...
static const iree_hal_executable_vtable_t iree_hal_null_executable_vtable = {
    ...
    .global_count = iree_hal_null_executable_global_count,
    .global_info_by_index = iree_hal_null_executable_global_info_by_index,
};
