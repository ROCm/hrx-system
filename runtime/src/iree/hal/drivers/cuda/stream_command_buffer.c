...
static iree_status_t iree_hal_cuda_stream_command_buffer_atomic_wait(
    iree_hal_command_buffer_t* base_command_buffer,
    iree_hal_execution_stage_t source_stage_mask,
    iree_hal_execution_stage_t target_stage_mask,
  ...
  return iree_make_status(
      ...
      "CUDA stream command buffers do not support atomic waits");
}

static iree_status_t iree_hal_cuda_stream_command_buffer_atomic_store(
    iree_hal_command_buffer_t* base_command_buffer,
    iree_hal_execution_stage_t source_stage_mask,
    iree_hal_execution_stage_t target_stage_mask,
  ...
  return iree_make_status(
      IREE_STATUS_UNIMPLEMENTED,
      "CUDA stream command buffers do not support atomic stores");
}

static iree_status_t iree_hal_cuda_stream_command_buffer_atomic_rmw(
    iree_hal_command_buffer_t* base_command_buffer,
    iree_hal_execution_stage_t source_stage_mask,
    iree_hal_execution_stage_t target_stage_mask,
  ...
  return iree_make_status(
      IREE_STATUS_UNIMPLEMENTED,
      "CUDA stream command buffers do not support atomic read-modify-write");
}
...
static const iree_hal_command_buffer_vtable_t
    iree_hal_cuda_stream_command_buffer_vtable = {
        ...
        .atomic_wait = iree_hal_cuda_stream_command_buffer_atomic_wait,
        .atomic_store = iree_hal_cuda_stream_command_buffer_atomic_store,
        .atomic_rmw = iree_hal_cuda_stream_command_buffer_atomic_rmw,
