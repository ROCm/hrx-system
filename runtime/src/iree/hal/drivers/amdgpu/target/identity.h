...
#ifndef IREE_HAL_DRIVERS_AMDGPU_TARGET_IDENTITY_H_
#define IREE_HAL_DRIVERS_AMDGPU_TARGET_IDENTITY_H_
...
#endif  // IREE_HAL_DRIVERS_AMDGPU_TARGET_IDENTITY_H_
