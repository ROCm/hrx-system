...
typedef struct iree_hal_amdgpu_device_atomic_pm4_context_t {
  ...
  iree_hal_amdgpu_device_kernel_pm4_launch_t wait_x32;
  // 64-bit atomic wait launch.
  iree_hal_amdgpu_device_kernel_pm4_launch_t wait_x64;
  // 32-bit atomic store launch.
  iree_hal_amdgpu_device_kernel_pm4_launch_t store_x32;
  // 64-bit atomic store launch.
  iree_hal_amdgpu_device_kernel_pm4_launch_t store_x64;
  // 32-bit atomic read-modify-write launch.
  iree_hal_amdgpu_device_kernel_pm4_launch_t rmw_x32;
  // 64-bit atomic read-modify-write launch.
  iree_hal_amdgpu_device_kernel_pm4_launch_t rmw_x64;
