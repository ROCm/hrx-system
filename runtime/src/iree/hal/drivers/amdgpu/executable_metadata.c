...
iree_status_t iree_hal_amdgpu_executable_metadata_storage_size(
  ...
  return IREE_STRUCT_LAYOUT(
      ...
      IREE_STRUCT_FIELD(counts->global_count, iree_hal_executable_global_info_t,
                        NULL),
...
iree_status_t iree_hal_amdgpu_executable_metadata_allocate(
  ...
  *out_metadata = NULL;
  ...
  iree_host_size_t globals_offset = 0;
  ...
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      ...
      IREE_STRUCT_LAYOUT(
          ...
          IREE_STRUCT_FIELD(counts->global_count,
                            iree_hal_executable_global_info_t, &globals_offset),
  ...
  if (iree_status_is_ok(status)) {
    ...
    metadata->globals =
        counts->global_count
            ? (iree_hal_executable_global_info_t*)(storage_base +
                                                   globals_offset)
            : NULL;
