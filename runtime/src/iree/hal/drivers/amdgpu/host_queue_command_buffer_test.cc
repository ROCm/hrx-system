...
TEST_F(HostQueueCommandBufferTest, Pm4MixedDynamicDispatchUsesGpuFixup) {
  ...
  iree_hal_buffer_binding_t invalid_bindings[4] = {
      {
  ...
  const iree_hal_buffer_binding_table_t invalid_binding_table = {
      /*count=*/IREE_ARRAYSIZE(invalid_bindings),
  ...
  IREE_EXPECT_STATUS_IS(
      ...
      iree_hal_device_queue_execute(
          ...
          command_buffer, invalid_binding_table, IREE_HAL_EXECUTE_FLAG_NONE));
...
TEST_F(HostQueueCommandBufferTest, Pm4DynamicDispatchUsesBindingTableSlots) {
  ...
  iree_hal_buffer_binding_t invalid_bindings[2] = {{0}, {0}};
  const iree_hal_buffer_binding_table_t invalid_binding_table = {
      /*count=*/IREE_ARRAYSIZE(invalid_bindings),
      /*bindings=*/invalid_bindings,
  };
