...
#ifndef IREE_HAL_DRIVERS_TASK_PROFILE_H_
#define IREE_HAL_DRIVERS_TASK_PROFILE_H_
...
// Emits task executable function metadata once per recorder session.
//
...
#endif  // IREE_HAL_DRIVERS_TASK_PROFILE_H_
