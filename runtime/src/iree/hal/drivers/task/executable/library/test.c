...
#include "iree/hal/drivers/task/executable/library/demo.h"
...
//
// See iree/hal/drivers/task/executable/library/abi.h for more information.
int main(int argc, char** argv) {
  ...
  const iree_hal_executable_dispatch_state_v0_t dispatch_state = {
      ...
      .workgroup_size_z = 1,
      .max_concurrency = 1,
      .constants = {(const uint8_t*)constants.values, sizeof(constants.values)},
