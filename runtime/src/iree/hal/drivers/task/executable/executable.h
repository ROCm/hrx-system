...
#ifndef IREE_HAL_DRIVERS_TASK_EXECUTABLE_EXECUTABLE_H_
#define IREE_HAL_DRIVERS_TASK_EXECUTABLE_EXECUTABLE_H_
...
} iree_hal_task_executable_t;

typedef struct iree_hal_task_executable_vtable_t {
  ...
  iree_status_t(IREE_API_PTR* issue_call)(
      ...
      uint32_t worker_id);
} iree_hal_task_executable_vtable_t;
...
#endif  // IREE_HAL_DRIVERS_TASK_EXECUTABLE_EXECUTABLE_H_
