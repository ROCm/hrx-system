...
#ifndef IREE_HAL_DRIVERS_TASK_EXECUTABLE_LOADERS_REGISTRATION_INIT_H_
#define IREE_HAL_DRIVERS_TASK_EXECUTABLE_LOADERS_REGISTRATION_INIT_H_
...
#endif  // IREE_HAL_DRIVERS_TASK_EXECUTABLE_LOADERS_REGISTRATION_INIT_H_
