...
#ifndef IREE_HAL_DRIVERS_TASK_EXECUTABLE_LOADERS_SYSTEM_LIBRARY_LOADER_H_
#define IREE_HAL_DRIVERS_TASK_EXECUTABLE_LOADERS_SYSTEM_LIBRARY_LOADER_H_
...
#endif  // IREE_HAL_DRIVERS_TASK_EXECUTABLE_LOADERS_SYSTEM_LIBRARY_LOADER_H_
