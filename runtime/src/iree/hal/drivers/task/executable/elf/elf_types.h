...
#ifndef IREE_HAL_DRIVERS_TASK_EXECUTABLE_ELF_ELF_TYPES_H_
#define IREE_HAL_DRIVERS_TASK_EXECUTABLE_ELF_ELF_TYPES_H_
...
#endif  // IREE_HAL_DRIVERS_TASK_EXECUTABLE_ELF_ELF_TYPES_H_
