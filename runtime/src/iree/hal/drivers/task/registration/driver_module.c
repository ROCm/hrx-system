...
static iree_status_t iree_hal_task_driver_factory_enumerate(
...
iree_hal_task_driver_module_register(iree_hal_driver_registry_t* registry) {
  static const iree_hal_driver_factory_t factory = {
      .self = NULL,
      .enumerate = iree_hal_task_driver_factory_enumerate,
      .try_create = iree_hal_task_driver_factory_try_create,
  };
