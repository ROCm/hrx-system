...
#ifndef IREE_HAL_DRIVERS_TASK_COMMAND_BLOCK_BUILDER_H_
#define IREE_HAL_DRIVERS_TASK_COMMAND_BLOCK_BUILDER_H_
...
#endif  // IREE_HAL_DRIVERS_TASK_COMMAND_BLOCK_BUILDER_H_
