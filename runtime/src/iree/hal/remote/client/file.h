...
// span or a proactor-managed async file handle. Synchronous-only files are not
// imported because remote queue file I/O must never call synchronous HAL file
// vtable methods.
