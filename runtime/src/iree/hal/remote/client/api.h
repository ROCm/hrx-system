...
//
// This call waits for the server to validate the logical path, open the file,
// and return its immutable extent and granted access. The returned HAL file can
// immediately be used with asynchronous queue file I/O operations; file data is
// never transferred synchronously by this call.
