...
#define STATIC_ASSERT_CONCAT_INNER_(lhs, rhs) lhs##rhs
#define STATIC_ASSERT_CONCAT_(lhs, rhs) STATIC_ASSERT_CONCAT_INNER_(lhs, rhs)
#define STATIC_ASSERT_ENUM_EQ(lhs, rhs)                                  \
  enum {                                                                 \
    STATIC_ASSERT_CONCAT_(static_assert_lhs_, __LINE__) = (lhs),         \
    STATIC_ASSERT_CONCAT_(static_assert_rhs_, __LINE__) = (rhs),         \
  };                                                                     \
  static_assert(STATIC_ASSERT_CONCAT_(static_assert_lhs_, __LINE__) ==   \
                    STATIC_ASSERT_CONCAT_(static_assert_rhs_, __LINE__), \
                "plugin/runtime API mismatch")
#define STATIC_ASSERT_EQ(lhs, rhs) \
  static_assert((lhs) == (rhs), "plugin/runtime API mismatch")

STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_OK, IREE_STATUS_OK);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_CANCELLED,
                      IREE_STATUS_CANCELLED);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_UNKNOWN,
                      IREE_STATUS_UNKNOWN);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_INVALID_ARGUMENT,
                      IREE_STATUS_INVALID_ARGUMENT);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_DEADLINE_EXCEEDED,
                      IREE_STATUS_DEADLINE_EXCEEDED);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_NOT_FOUND,
                      IREE_STATUS_NOT_FOUND);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_ALREADY_EXISTS,
                      IREE_STATUS_ALREADY_EXISTS);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_PERMISSION_DENIED,
                      IREE_STATUS_PERMISSION_DENIED);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_RESOURCE_EXHAUSTED,
                      IREE_STATUS_RESOURCE_EXHAUSTED);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_FAILED_PRECONDITION,
                      IREE_STATUS_FAILED_PRECONDITION);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_ABORTED,
                      IREE_STATUS_ABORTED);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_OUT_OF_RANGE,
                      IREE_STATUS_OUT_OF_RANGE);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_UNIMPLEMENTED,
                      IREE_STATUS_UNIMPLEMENTED);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_INTERNAL,
                      IREE_STATUS_INTERNAL);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_UNAVAILABLE,
                      IREE_STATUS_UNAVAILABLE);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_DATA_LOSS,
                      IREE_STATUS_DATA_LOSS);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_UNAUTHENTICATED,
                      IREE_STATUS_UNAUTHENTICATED);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_DEFERRED,
                      IREE_STATUS_DEFERRED);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_STATUS_CODE_MASK,
                      IREE_STATUS_CODE_MASK);

STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_ALLOCATOR_COMMAND_MALLOC,
                      IREE_ALLOCATOR_COMMAND_MALLOC);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_ALLOCATOR_COMMAND_CALLOC,
                      IREE_ALLOCATOR_COMMAND_CALLOC);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_ALLOCATOR_COMMAND_REALLOC,
                      IREE_ALLOCATOR_COMMAND_REALLOC);
STATIC_ASSERT_ENUM_EQ(IREE_HAL_EXECUTABLE_PLUGIN_ALLOCATOR_COMMAND_FREE,
...
#undef STATIC_ASSERT_ENUM_EQ
#undef STATIC_ASSERT_CONCAT_
#undef STATIC_ASSERT_CONCAT_INNER_
