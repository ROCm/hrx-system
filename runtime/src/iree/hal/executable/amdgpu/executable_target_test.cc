...
TEST(ExecutableTargetTest, AdvertisesPhysicalRevisionOnExactTarget) {
  ...
  IREE_ASSERT_OK(
      iree_hal_amdgpu_target_identity_apply_asic_revision(0, &identity));
