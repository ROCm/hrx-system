...
// capacities and the remote memory location used for credit returns. This file
// owns the wire layout so the connection state machine and carrier do not
// reinterpret ad-hoc structs.
...
#define IREE_NET_RDMA_CONNECTION_DATA_VERSION ((uint16_t)1u)
