...
Use the installed TheRock SDK wheels with Visual Studio and the ROCm clang-cl
toolchain. See [Windows](BUILDING.md#windows) for prerequisites, configuration,
testing, and installation commands.
